---
auto_generated: true
description: Sets multiple specified options in the DataFrameReader.
last_scraped: '2026-01-14T16:54:54.354083+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/developer-guide/snowpark/reference/python/latest/snowpark/api/snowflake.snowpark.DataFrameReader.options
title: snowflake.snowpark.DataFrameReader.options | Snowflake Documentation
---
...
[Developer](../../../../../../../developer.md)[Snowpark API](../../../../../index.md)[Python](../../../../../python/index.md)[Python API Reference](../../index.md)[Snowpark APIs](../index.md)[Input/Output](../io.md)DataFrameReader.options

# snowflake.snowpark.DataFrameReader.options[¶](#snowflake-snowpark-dataframereader-options "Permalink to this heading")

DataFrameReader.options(*configs: Optional[Dict] = None*, *\*\*kwargs*) → [DataFrameReader](snowflake.snowpark.DataFrameReader.html#snowflake.snowpark.DataFrameReader "snowflake.snowpark.dataframe_reader.DataFrameReader")[[source]](https://github.com/snowflakedb/snowpark-python/blob/v1.44.0/src/snowflake/snowpark/dataframe_reader.py#L1114-L1137)[¶](#snowflake.snowpark.DataFrameReader.options "Permalink to this definition")
:   Sets multiple specified options in the DataFrameReader.

    This method is the same as the [`option()`](snowflake.snowpark.DataFrameReader.option.html#snowflake.snowpark.DataFrameReader.option "snowflake.snowpark.DataFrameReader.option") except that you can set multiple options in one call.
