---
auto_generated: true
description: With Snowpark Connect for Spark, you can interact directly with external
  cloud storage systems such as Amazon S3, Google Cloud Storage, and Azure Blob. You
  can read data from cloud storage into Snowfl
last_scraped: '2026-01-14T16:57:54.305232+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/developer-guide/snowpark-connect/snowpark-connect-file-data
title: Access to cloud service file data with Snowpark Connect for Spark | Snowflake
  Documentation
---
...
[Developer](../../developer.md)[Spark workloads on Snowflake](snowpark-connect-overview.md)Cloud service data access

# Access to cloud service file data with Snowpark Connect for Spark[¶](#access-to-cloud-service-file-data-with-spconnect "Link to this heading")
...
## Access using Snowflake external stages[¶](#access-using-snowflake-external-stages "Link to this heading")
...
## Access using direct access[¶](#access-using-direct-access "Link to this heading")
...
3. [Access using Snowflake external stages](#access-using-snowflake-external-stages)
4. [Access using direct access](#access-using-direct-access)

Related content

1. [Configuring secure access to Amazon S3](/developer-guide/snowpark-connect/../../user-guide/data-load-s3-config)
2. [Creating an Azure stage](/developer-guide/snowpark-connect/../../user-guide/data-load-azure-create-stage)
3. [Configuring an integration for Google Cloud Storage](/developer-guide/snowpark-connect/../../user-guide/data-load-gcs-config)