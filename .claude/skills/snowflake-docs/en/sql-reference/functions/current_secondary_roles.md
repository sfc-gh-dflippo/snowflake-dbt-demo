...
last_scraped: '2026-01-14T16:58:02.827752+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/current_secondary_roles
title: CURRENT_SECONDARY_ROLES | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Context](../functions-context.md)CURRENT\_SECONDARY\_ROLES

Categories:
:   [Context functions](../functions-context) (Session Object)

# CURRENT\_SECONDARY\_ROLES[¶](#current-secondary-roles "Link to this heading")

Returns the [secondary roles](../../user-guide/security-access-control-overview.html#label-access-control-role-enforcement) in use for the current session.

To activate a different set of secondary roles for the session, execute the [USE SECONDARY ROLES](../sql/use-secondary-roles) command.
