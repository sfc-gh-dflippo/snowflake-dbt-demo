...
last_scraped: '2026-01-14T16:55:47.769776+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/octet_length.html
title: OCTET_LENGTH | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)OCTET\_LENGTH

Categories:
:   [String & binary functions](../functions-string) (General)

# OCTET\_LENGTH[¶](#octet-length "Link to this heading")
