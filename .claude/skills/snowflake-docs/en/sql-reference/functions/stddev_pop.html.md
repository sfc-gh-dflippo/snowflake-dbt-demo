...
last_scraped: '2026-01-14T16:57:17.863460+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/stddev_pop.html
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Aggregate](../functions-aggregation.md)STDDEV\_POP

Categories:
:   [Aggregate functions](../functions-aggregation) (General) , [Window function syntax and usage](../functions-window-syntax) (General)

# STDDEV\_POP[¶](#stddev-pop "Link to this heading")

Returns the population standard deviation (square root of variance) of non-NULL values.

See also [STDDEV](stddev), which returns the sample standard deviation (square root of variance).
...
* When this function is called as a window function and the OVER clause contains an ORDER BY clause:
  ...
  + A window frame must be specified. If you do not specify a window frame, the following implied window frame is used:
    ...
    [Window function syntax and usage](../functions-window-syntax).
