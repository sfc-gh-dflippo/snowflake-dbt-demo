...
last_scraped: '2026-01-14T16:55:58.087342+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/last_query_id
title: LAST_QUERY_ID | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Context](../functions-context.md)LAST\_QUERY\_ID

Categories:
:   [Context functions](../functions-context) (Session)

# LAST\_QUERY\_ID[¶](#last-query-id "Link to this heading")
...
Instead of using this function with the [RESULT\_SCAN](result_scan) function to process the results of a
previous command, you can use the [pipe operator](../operators-flow) (`->>`). That way,
...
* The last LAST\_QUERY\_ID function considers all statements that were run within the current session,
  ...
  anonymous block, or [pipe operator](../operators-flow) statement). If you want to
...
1. [RESULT\_SCAN](/sql-reference/functions/result_scan)