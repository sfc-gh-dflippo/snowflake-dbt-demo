...
last_scraped: '2026-01-14T16:58:03.382984+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/is_granted_to_invoker_role
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Context](../functions-context.md)IS\_GRANTED\_TO\_INVOKER\_ROLE

Categories:
:   [Context functions](../functions-context) (Session Object)

# IS\_GRANTED\_TO\_INVOKER\_ROLE[¶](#is-granted-to-invoker-role "Link to this heading")
...
* The following table summarizes the context in which you can call the function and the role hierarchy Snowflake evaluates.
  ...
  | --- | --- |
  | User | [CURRENT\_ROLE](current_role) |
  | Table | CURRENT\_ROLE. |
  ...
  | Stream | The role that queries a given [stream](../../user-guide/streams-intro.html#label-stream-required-privileges). |
* If prefer to evaluate the role hierarchy for the current session, call [IS\_ROLE\_IN\_SESSION](is_role_in_session) instead.
