...
last_scraped: '2026-01-14T16:54:37.811107+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/first_value
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Window](../functions-window.md)FIRST\_VALUE

Categories:
:   [Window function syntax and usage](../functions-window-syntax) (Ranking)

# FIRST\_VALUE[¶](#first-value "Link to this heading")

Returns the first value within an ordered group of values.

See also:
:   [LAST\_VALUE](last_value) , [NTH\_VALUE](nth_value)
...
This example shows a simple query that uses the FIRST\_VALUE function. This query contains two ORDER BY clauses: one to
...
The following example returns the results of three related functions: FIRST\_VALUE,
[NTH\_VALUE](nth_value), and [LAST\_VALUE](last_value).
