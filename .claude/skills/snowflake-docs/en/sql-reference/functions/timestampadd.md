...
last_scraped: '2026-01-14T16:57:59.745459+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/timestampadd
title: TIMESTAMPADD | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Date & time](../functions-date-time.md)TIMESTAMPADD

Categories:
:   [Date & time functions](../functions-date-time)

# TIMESTAMPADD[¶](#timestampadd "Link to this heading")
