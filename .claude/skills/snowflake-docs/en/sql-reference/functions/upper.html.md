...
last_scraped: '2026-01-14T16:57:22.215469+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/upper.html
title: UPPER | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)UPPER

Categories:
:   [String & binary functions](../functions-string) (Case Conversion)
...
UPPER supports [collation](../collation) specifications. This UPPER example
