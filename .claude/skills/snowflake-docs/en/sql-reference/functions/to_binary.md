...
last_scraped: '2026-01-14T16:56:08.450962+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/to_binary
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Conversion](../functions-conversion.md)TO\_BINARY

Categories:
:   [Conversion functions](../functions-conversion)

# TO\_BINARY[¶](#to-binary "Link to this heading")

Converts the input expression to a binary value. For NULL input, the output is NULL.

See also:

* [TRY\_TO\_BINARY](try_to_binary).
