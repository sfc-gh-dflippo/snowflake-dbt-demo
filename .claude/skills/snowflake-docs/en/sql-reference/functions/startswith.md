...
last_scraped: '2026-01-14T16:56:16.791103+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/startswith
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)STARTSWITH

Categories:
:   [String & binary functions](../functions-string) (Matching/Comparison)

# STARTSWITH[¶](#startswith "Link to this heading")
