...
last_scraped: '2026-01-14T16:56:17.997290+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/st_geographyfromwkt
title: ST_GEOGRAPHYFROMWKT | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Geospatial](../functions-geospatial.md)ST\_GEOGRAPHYFROMWKT

Categories:
:   [Geospatial functions](../functions-geospatial), [Conversion functions](../functions-conversion)

# ST\_GEOGRAPHYFROMWKT[¶](#st-geographyfromwkt "Link to this heading")

Parses a
[WKT (well-known text)](https://en.wikipedia.org/wiki/Well-known_text_representation_of_geometry) or
[EWKT (extended well-known text)](../data-types-geospatial.html#label-a-note-on-ewkt-ewkb-handling) input and returns a value of type
[GEOGRAPHY](../data-types-geospatial.html#label-data-types-geography).

Aliases:
:   ST\_GEOGFROMWKT , ST\_GEOGRAPHYFROMEWKT , ST\_GEOGFROMEWKT , ST\_GEOGRAPHYFROMTEXT , ST\_GEOGFROMTEXT

See also:
:   [TO\_GEOGRAPHY](to_geography)
...
:   If TRUE, specifies that the function returns a GEOGRAPHY or GEOMETRY object, even when the input shape isn’t valid and
    can’t be repaired. For more information, see [Specifying how invalid geospatial shapes are handled](../data-types-geospatial.html#label-geospatial-invalid-shape-handling-intro).

## Returns[¶](#returns "Link to this heading")

The function returns a value of type [GEOGRAPHY](../data-types-geospatial.html#label-data-types-geography).
...
* Issues an error if the input format is EWKT and the SRID is not 4326.
  See the [note on EWKT and EWKB handling](../data-types-geospatial.html#label-a-note-on-ewkt-ewkb-handling).
