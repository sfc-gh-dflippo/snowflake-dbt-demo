...
last_scraped: '2026-01-14T16:56:12.654002+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/array_flatten
title: ARRAY_FLATTEN | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Semi-structured and structured data](../functions-semistructured.md)ARRAY\_FLATTEN

Categories:
:   [Semi-structured and structured data functions](../functions-semistructured) (Array/Object)

# ARRAY\_FLATTEN[¶](#array-flatten "Link to this heading")

Flattens an [ARRAY](../data-types-semistructured.html#label-data-type-array) of ARRAYs into a single ARRAY. The function effectively concatenates the ARRAYs that
