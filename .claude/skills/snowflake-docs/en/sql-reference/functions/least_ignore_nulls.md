...
last_scraped: '2026-01-14T16:56:50.874768+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/least_ignore_nulls
title: LEAST_IGNORE_NULLS | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Conditional expression](../expressions-conditional.md)LEAST\_IGNORE\_NULLS

Categories:
:   [Conditional expression functions](../expressions-conditional)

# LEAST\_IGNORE\_NULLS[¶](#least-ignore-nulls "Link to this heading")
