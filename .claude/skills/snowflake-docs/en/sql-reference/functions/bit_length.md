...
last_scraped: '2026-01-14T16:57:11.319035+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/bit_length
title: BIT_LENGTH | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)BIT\_LENGTH

Categories:
:   [String & binary functions](../functions-string) (General)

# BIT\_LENGTH[¶](#bit-length "Link to this heading")

Returns the length of a string or binary value in bits.

Snowflake doesn’t use fractional bytes so length is always calculated as 8 \* [OCTET\_LENGTH](octet_length).
