...
last_scraped: '2026-01-14T16:54:39.129326+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/last_value
title: LAST_VALUE | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Window](../functions-window.md)LAST\_VALUE

Categories:
:   [Window function syntax and usage](../functions-window-syntax) (Ranking)

# LAST\_VALUE[¶](#last-value "Link to this heading")

Returns the last value within an ordered group of values.

See also:
:   [FIRST\_VALUE](first_value) , [NTH\_VALUE](nth_value)
...
[NTH\_VALUE](nth_value), and LAST\_VALUE.
