...
last_scraped: '2026-01-14T16:56:12.026417+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/max_by
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Aggregate](../functions-aggregation.md)MAX\_BY

Categories:
:   [Aggregate functions](../functions-aggregation) (General)

# MAX\_BY[¶](#max-by "Link to this heading")
...
* The function returns an [ARRAY](../data-types-semistructured.html#label-data-type-array) containing the values of a column for the rows with the highest
