...
last_scraped: '2026-01-14T16:54:29.880847+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/kurtosis
title: KURTOSIS | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Aggregate](../functions-aggregation.md)KURTOSIS

Categories:
:   [Aggregate functions](../functions-aggregation) (General) , [Window function syntax and usage](../functions-window-syntax)

# KURTOSIS[¶](#kurtosis "Link to this heading")
...
\[(n \* (n+1))/((n-1) \* (n-2) \* (n-3)) \* (n \* m\_4/(k\_2)^2) - 3 \* (n-1)^2 / ((n-2) \* (n-3))\]

where:

* \(n\) denotes the number of non-NULL records.
* \(m\_4\) denotes the sample fourth central moment.
* \(k\_2\) denotes the symmetric unbiased estimator of the variance.
