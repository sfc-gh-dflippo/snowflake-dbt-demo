...
last_scraped: '2026-01-14T16:56:13.045563+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/endswith
title: ENDSWITH | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)ENDSWITH

Categories:
:   [String & binary functions](../functions-string) (Matching/Comparison)

# ENDSWITH[¶](#endswith "Link to this heading")
...
### Determine whether column values contain a string[¶](#determine-whether-column-values-contain-a-string "Link to this heading")
...
### Use ENDSWITH with collation[¶](#use-endswith-with-collation "Link to this heading")
