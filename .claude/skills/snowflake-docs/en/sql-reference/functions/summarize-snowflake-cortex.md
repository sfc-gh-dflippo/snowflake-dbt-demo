...
last_scraped: '2026-01-14T16:57:55.061580+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/summarize-snowflake-cortex
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)AI FunctionsScalar functionsSUMMARIZE (SNOWFLAKE.CORTEX)

Categories:
:   [String & binary functions](../functions-string) (AI Functions)

# SUMMARIZE (SNOWFLAKE.CORTEX)[¶](#summarize-snowflake-cortex "Link to this heading")
