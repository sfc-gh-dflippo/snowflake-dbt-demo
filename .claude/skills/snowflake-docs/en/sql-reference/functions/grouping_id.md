...
last_scraped: '2026-01-14T16:57:56.278490+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/grouping_id
title: GROUPING_ID | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Aggregate](../functions-aggregation.md)GROUPING\_ID

Categories:
:   [Aggregate functions](../functions-aggregation) (General)

# GROUPING\_ID[¶](#grouping-id "Link to this heading")

Describes which of a list of expressions are grouped in a row produced by a [GROUP BY](../constructs/group-by) query.
