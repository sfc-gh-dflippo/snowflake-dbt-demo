...
last_scraped: '2026-01-14T16:56:49.809304+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/greatest_ignore_nulls
title: GREATEST_IGNORE_NULLS | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Conditional expression](../expressions-conditional.md)GREATEST\_IGNORE\_NULLS

Categories:
:   [Conditional expression functions](../expressions-conditional)

# GREATEST\_IGNORE\_NULLS[¶](#greatest-ignore-nulls "Link to this heading")
