...
last_scraped: '2026-01-14T16:57:00.076744+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/getdate
title: GETDATE | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Context](../functions-context.md)GETDATE
...
Alias for [CURRENT\_TIMESTAMP](current_timestamp).
...
* This function does not support the `fract_sec_precision` argument that is supported by
  the [CURRENT\_TIMESTAMP](current_timestamp) function.
