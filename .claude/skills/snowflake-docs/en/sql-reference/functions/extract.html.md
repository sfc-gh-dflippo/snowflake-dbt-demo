...
last_scraped: '2026-01-14T16:55:16.715532+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/extract.html
title: EXTRACT | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Date & time](../functions-date-time.md)EXTRACT

Categories:
:   [Date & time functions](../functions-date-time)

# EXTRACT[¶](#extract "Link to this heading")

Extracts the specified date or time part from a date, time, or timestamp.

Tip

To extract the date from a timestamp, use the [TO\_DATE](to_date) function.

Alternatives:
:   [DATE\_PART](date_part) , [HOUR / MINUTE / SECOND](hour-minute-second) , [YEAR\* / DAY\* / WEEK\* / MONTH / QUARTER](year)
...
Use EXTRACT with the [DECODE](decode) function and the `dayofweek` part to return the full name of the
...
The output depends on the value returned by the [SYSTIMESTAMP](systimestamp) function when you run the query. Also, you can use the
[DAYNAME](dayname) function to extract the three-letter day-of-week name from the specified date or timestamp.
