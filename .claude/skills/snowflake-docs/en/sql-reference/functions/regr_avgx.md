...
last_scraped: '2026-01-14T16:54:32.400224+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/regr_avgx
title: REGR_AVGX | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Aggregate](../functions-aggregation.md)REGR\_AVGX

Categories:
:   [Aggregate functions](../functions-aggregation) (Linear Regression) , [Window functions](../functions-window)

# REGR\_AVGX[¶](#regr-avgx "Link to this heading")
