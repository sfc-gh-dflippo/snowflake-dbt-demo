...
last_scraped: '2026-01-14T16:58:00.097582+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/timeadd
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Date & time](../functions-date-time.md)TIMEADD

Categories:
:   [Date & time functions](../functions-date-time)

# TIMEADD[¶](#timeadd "Link to this heading")
