...
description: Aggregate functions (Linear Regression) , Window function syntax and
  usage
last_scraped: '2026-01-14T16:57:12.967927+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/regr_r2
title: REGR_R2 | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Aggregate](../functions-aggregation.md)REGR\_R2

Categories:
:   [Aggregate functions](../functions-aggregation) (Linear Regression) , [Window function syntax and usage](../functions-window-syntax)

# REGR\_R2[¶](#regr-r2 "Link to this heading")
