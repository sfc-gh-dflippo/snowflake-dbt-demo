...
last_scraped: '2026-01-14T16:57:19.347736+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/left.html
title: LEFT | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)LEFT
...
Use the [POSITION](position) function with the LEFT function to extract the username from email addresses.
