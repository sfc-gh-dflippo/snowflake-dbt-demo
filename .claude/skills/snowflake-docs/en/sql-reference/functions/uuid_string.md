...
last_scraped: '2026-01-14T16:57:12.236688+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/uuid_string
title: UUID_STRING | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)UUID\_STRING

Categories:
:   [String & binary functions](../functions-string) (General) , [Data generation functions](../functions-data-generation)

# UUID\_STRING[¶](#uuid-string "Link to this heading")
