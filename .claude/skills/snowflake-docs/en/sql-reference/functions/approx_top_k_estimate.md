---
auto_generated: true
description: Aggregate functions (Frequency Estimation) , Window function syntax and
  usage
last_scraped: '2026-01-14T16:57:57.765097+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/approx_top_k_estimate
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Aggregate](../functions-aggregation.md)APPROX\_TOP\_K\_ESTIMATE

Categories:
:   [Aggregate functions](../functions-aggregation) (Frequency Estimation) , [Window function syntax and usage](../functions-window-syntax)

# APPROX\_TOP\_K\_ESTIMATE[¶](#approx-top-k-estimate "Link to this heading")
...
A Space-Saving state produced by [APPROX\_TOP\_K\_ACCUMULATE](approx_top_k_accumulate) and [APPROX\_TOP\_K\_COMBINE](approx_top_k_combine) can be used to compute a cardinality estimate using the APPROX\_TOP\_K\_ESTIMATE function.

Thus, APPROX\_TOP\_K\_ESTIMATE(APPROX\_TOP\_K\_ACCUMULATE(…)) is equivalent to APPROX\_TOP\_K(…).

See also:
:   [APPROX\_TOP\_K](approx_top_k) , [APPROX\_TOP\_K\_ACCUMULATE](approx_top_k_accumulate) , [APPROX\_TOP\_K\_COMBINE](approx_top_k_combine)
...
:   An expression that contains state information generated
    by a call to [APPROX\_TOP\_K\_ACCUMULATE](approx_top_k_accumulate) or
    [APPROX\_TOP\_K\_COMBINE](approx_top_k_combine).
...
* Decimal-float ([DECFLOAT](../data-types-numeric.html#label-data-type-decfloat)) values aren’t supported.
...
approximate Top K information for the table named sequence\_demo:
