...
last_scraped: '2026-01-14T16:57:55.449637+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/unicode
title: UNICODE | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)UNICODE
...
and `NULL` values. It also demonstrates how the UNICODE and [CHAR](chr) functions interact:
