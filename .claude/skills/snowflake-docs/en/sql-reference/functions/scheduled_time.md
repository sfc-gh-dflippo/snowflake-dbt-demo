...
last_scraped: '2026-01-14T16:58:00.431488+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/scheduled_time
title: SCHEDULED_TIME | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Date & time](../functions-date-time.md)SCHEDULED\_TIME

Categories:
:   [Date & time functions](../functions-date-time) (Alerts)

# SCHEDULED\_TIME[¶](#scheduled-time "Link to this heading")

Returns the timestamp representing the scheduled time of the current alert. Refer to [Specifying timestamps based on alert schedules](../../user-guide/alerts.html#label-alerts-specify-timestamps).
...
* This function is defined in the ALERT schema of the SNOWFLAKE database.
  ...
  [SNOWFLAKE database role](../snowflake-db-roles) ALERT\_VIEWER. For example, to call the function as a user
...
Refer to [Specifying timestamps based on alert schedules](../../user-guide/alerts.html#label-alerts-specify-timestamps).
