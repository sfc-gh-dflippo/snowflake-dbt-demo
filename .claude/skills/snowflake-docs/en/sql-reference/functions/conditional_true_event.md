...
last_scraped: '2026-01-14T16:57:58.652034+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/conditional_true_event
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Window](../functions-window.md)CONDITIONAL\_TRUE\_EVENT

Categories:
:   [Window functions](../functions-window) (General)

# CONDITIONAL\_TRUE\_EVENT[¶](#conditional-true-event "Link to this heading")
