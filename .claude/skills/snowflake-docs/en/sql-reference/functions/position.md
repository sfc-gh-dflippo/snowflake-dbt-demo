...
last_scraped: '2026-01-14T16:56:49.474290+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/position
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)POSITION
...
If you need to find the position beyond the first occurrence (for example, the third occurrence), you can use the [REGEXP\_INSTR](regexp_instr) function.
...
### VARCHAR expressions[¶](#varchar-expressions "Link to this heading")
...
### BINARY expressions[¶](#binary-expressions "Link to this heading")
