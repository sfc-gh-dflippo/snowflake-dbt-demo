...
last_scraped: '2026-01-14T16:57:25.509315+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/rank.html
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Window](../functions-window.md)RANK

Categories:
:   [Window functions](../functions-window) (Ranking)
...
* To avoid gaps, use the [DENSE\_RANK](dense_rank) function instead.
