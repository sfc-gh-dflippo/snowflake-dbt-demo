...
last_scraped: '2026-01-14T16:54:36.762232+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/current_date
title: CURRENT_DATE | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Context](../functions-context.md)CURRENT\_DATE

Categories:
:   [Context functions](../functions-context) (General)

# CURRENT\_DATE[¶](#current-date "Link to this heading")
...
The function returns a value of type [DATE](../data-types-datetime.html#label-datatypes-date).

## Usage notes[¶](#usage-notes "Link to this heading")

* The setting of the [TIMEZONE](../parameters.html#label-timezone) parameter affects the return value. The returned date is
  in the time zone for the session.
* The display format for dates in the output is determined by the [DATE\_OUTPUT\_FORMAT](../parameters.html#label-date-output-format)
