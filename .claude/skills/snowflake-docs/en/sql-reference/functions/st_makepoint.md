...
last_scraped: '2026-01-14T16:56:16.481388+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/st_makepoint
title: ST_MAKEPOINT , ST_POINT | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Geospatial](../functions-geospatial.md)ST\_MAKEPOINT

Categories:
:   [Geospatial functions](../functions-geospatial)

# ST\_MAKEPOINT , ST\_POINT[¶](#st-makepoint-st-point "Link to this heading")

Constructs a [GEOGRAPHY](../data-types-geospatial.html#label-data-types-geography) object that represents a point with the specified longitude
and latitude.
