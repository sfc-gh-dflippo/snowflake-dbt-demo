...
last_scraped: '2026-01-14T16:56:17.614812+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/array_to_string
title: ARRAY_TO_STRING | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Semi-structured and structured data](../functions-semistructured.md)ARRAY\_TO\_STRING

Categories:
:   [Semi-structured and structured data functions](../functions-semistructured) (Array/Object)

# ARRAY\_TO\_STRING[¶](#array-to-string "Link to this heading")

Returns an input array converted to a string by casting all values to strings (using [TO\_VARCHAR](to_char)) and concatenating them (using the string from the second argument to separate the
elements).
