...
last_scraped: '2026-01-14T16:54:28.658424+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/acosh
title: ACOSH | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Numeric](../functions-numeric.md)ACOSH
...
:   The value or expression to operate on. Must be greater than or equal to 1.0.
    The data type must be FLOAT or DECFLOAT.
