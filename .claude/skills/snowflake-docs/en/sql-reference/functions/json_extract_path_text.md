...
last_scraped: '2026-01-14T16:56:10.095217+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/json_extract_path_text
title: JSON_EXTRACT_PATH_TEXT | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Semi-structured and structured data](../functions-semistructured.md)JSON\_EXTRACT\_PATH\_TEXT

Categories:
:   [Semi-structured and structured data functions](../functions-semistructured) (Extraction)

# JSON\_EXTRACT\_PATH\_TEXT[¶](#json-extract-path-text "Link to this heading")
