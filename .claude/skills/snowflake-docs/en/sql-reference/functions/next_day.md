...
last_scraped: '2026-01-14T16:56:59.085303+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/next_day
title: NEXT_DAY | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Date & time](../functions-date-time.md)NEXT\_DAY

Categories:
:   [Date & time functions](../functions-date-time)

# NEXT\_DAY[¶](#next-day "Link to this heading")

Returns the date of the first specified day of week (DOW) that occurs after the input date.

See also:
:   [LAST\_DAY](last_day) , [PREVIOUS\_DAY](previous_day)
