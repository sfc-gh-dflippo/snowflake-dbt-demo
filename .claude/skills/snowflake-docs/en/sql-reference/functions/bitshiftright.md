...
last_scraped: '2026-01-14T16:55:52.793846+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/bitshiftright
title: BITSHIFTRIGHT | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Bitwise expression](../expressions-byte-bit.md)BITSHIFTRIGHT

Categories:
:   [Bitwise expression functions](../expressions-byte-bit)

# BITSHIFTRIGHT[¶](#bitshiftright "Link to this heading")
...
### Using BITSHIFTRIGHT with BINARY argument values[¶](#using-bitshiftright-with-binary-argument-values "Link to this heading")
