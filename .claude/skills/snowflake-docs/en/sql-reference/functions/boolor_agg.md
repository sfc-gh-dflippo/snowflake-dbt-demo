...
description: Aggregate functions (Boolean) , Window functions , Conditional expression
  functions
last_scraped: '2026-01-14T16:56:13.415019+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/boolor_agg
title: BOOLOR_AGG | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Aggregate](../functions-aggregation.md)BOOLOR\_AGG
...
# BOOLOR\_AGG[¶](#boolor-agg "Link to this heading")
...
See also:
:   [BOOLOR](boolor) , [BOOLAND\_AGG](booland_agg) , [BOOLXOR\_AGG](boolxor_agg)
