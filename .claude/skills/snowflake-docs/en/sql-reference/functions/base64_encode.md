...
last_scraped: '2026-01-14T16:56:05.416627+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/base64_encode
title: BASE64_ENCODE | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)BASE64\_ENCODE

Categories:
:   [String & binary functions](../functions-string) (Encoding/Decoding)

# BASE64\_ENCODE[¶](#base64-encode "Link to this heading")

Encodes the input (string or binary) using Base64 encoding.

See also:
:   [BASE64\_DECODE\_BINARY](base64_decode_binary) , [BASE64\_DECODE\_STRING](base64_decode_string)
...
## Returns[¶](#id1 "Link to this heading")
