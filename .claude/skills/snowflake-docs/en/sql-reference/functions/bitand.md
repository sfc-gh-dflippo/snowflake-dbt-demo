...
last_scraped: '2026-01-14T16:56:56.052540+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/bitand
title: BITAND | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Bitwise expression](../expressions-byte-bit.md)BITAND

Categories:
:   [Bitwise expression functions](../expressions-byte-bit)

# BITAND[¶](#bitand "Link to this heading")
