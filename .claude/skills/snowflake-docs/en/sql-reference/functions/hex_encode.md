...
last_scraped: '2026-01-14T16:56:14.529729+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/hex_encode
title: HEX_ENCODE | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)HEX\_ENCODE

Categories:
:   [String & binary functions](../functions-string) (Encoding/Decoding)

# HEX\_ENCODE[¶](#hex-encode "Link to this heading")
...
See also:
:   [HEX\_DECODE\_BINARY](hex_decode_binary) , [HEX\_DECODE\_STRING](hex_decode_string)
