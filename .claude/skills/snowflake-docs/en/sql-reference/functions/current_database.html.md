...
last_scraped: '2026-01-14T16:57:26.286366+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/current_database.html
title: CURRENT_DATABASE | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Context](../functions-context.md)CURRENT\_DATABASE

Categories:
:   [Context functions](../functions-context) (Session Object)

# CURRENT\_DATABASE[¶](#current-database "Link to this heading")
