...
last_scraped: '2026-01-14T16:56:51.902318+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/reverse
title: REVERSE | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)REVERSE
...
1. [Syntax](#syntax)
2. [Collation details](#collation-details)
3. [Examples](#examples)