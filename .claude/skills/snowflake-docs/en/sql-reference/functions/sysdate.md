...
last_scraped: '2026-01-14T16:56:56.556705+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/sysdate
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Context](../functions-context.md)SYSDATE

Categories:
:   [Context functions](../functions-context) (General)

# SYSDATE[¶](#sysdate "Link to this heading")
...
The data type of the returned value is [TIMESTAMP\_NTZ](../data-types-datetime.html#label-datatypes-timestamp-variations).
