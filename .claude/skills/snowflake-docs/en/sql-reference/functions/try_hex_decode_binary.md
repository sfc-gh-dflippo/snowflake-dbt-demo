...
last_scraped: '2026-01-14T16:56:17.170412+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/try_hex_decode_binary
title: TRY_HEX_DECODE_BINARY | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)TRY\_HEX\_DECODE\_BINARY

Categories:
:   [String & binary functions](../functions-string) (Encoding/Decoding)

# TRY\_HEX\_DECODE\_BINARY[¶](#try-hex-decode-binary "Link to this heading")

A special version of [HEX\_DECODE\_BINARY](hex_decode_binary) that
