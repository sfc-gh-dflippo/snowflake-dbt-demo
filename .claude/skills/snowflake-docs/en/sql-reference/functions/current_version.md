...
last_scraped: '2026-01-14T16:58:04.369666+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/current_version
title: CURRENT_VERSION | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Context](../functions-context.md)CURRENT\_VERSION

Categories:
:   [Context functions](../functions-context) (General)

# CURRENT\_VERSION[¶](#current-version "Link to this heading")

Returns the current Snowflake version.

See also:
:   [CURRENT\_CLIENT](current_client)
...
* This function returns version number information for Snowflake. To retrieve information about client versions,
  see [CURRENT\_CLIENT](current_client).
