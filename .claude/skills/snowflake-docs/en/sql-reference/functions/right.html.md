...
last_scraped: '2026-01-14T16:57:23.058749+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/right.html
title: RIGHT | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[String & binary](../functions-string.md)RIGHT
...
Use the [LENGTH](length) and [POSITION](position) functions with the RIGHT function to extract the domains from
