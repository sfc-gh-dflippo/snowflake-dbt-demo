...
last_scraped: '2026-01-14T16:56:55.517670+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/bitxor
title: BITXOR | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Bitwise expression](../expressions-byte-bit.md)BITXOR

Categories:
:   [Bitwise expression functions](../expressions-byte-bit)

# BITXOR[¶](#bitxor "Link to this heading")
