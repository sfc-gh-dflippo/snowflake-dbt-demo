...
last_scraped: '2026-01-14T16:57:01.955256+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/functions/is_array
title: IS_ARRAY | Snowflake Documentation
---
...
[Reference](../../reference.md)[Function and stored procedure reference](../../sql-reference-functions.md)[Semi-structured and structured data](../functions-semistructured.md)IS\_ARRAY

Categories:
:   [Semi-structured and structured data functions](../functions-semistructured) (Type Predicates)

# IS\_ARRAY[¶](#is-array "Link to this heading")

Returns TRUE if its [VARIANT](../data-types-semistructured.html#label-data-type-variant) argument contains an [ARRAY](../data-types-semistructured.html#label-data-type-array) value.

See also:
:   [IS\_<object\_type>](is) , [IS\_OBJECT](is_object)
...
* This function doesn’t support a [structured type](../data-types-structured) as an input argument.

## Examples[¶](#examples "Link to this heading")

The following examples use the IS\_ARRAY function.

### Use the IS\_ARRAY function in a WHERE clause[¶](#use-the-is-array-function-in-a-where-clause "Link to this heading")
...
Show the ARRAY values in the data by using the IS\_ARRAY function in a WHERE clause:
...
### Use the IS\_ARRAY function in a SELECT list[¶](#use-the-is-array-function-in-a-select-list "Link to this heading")
...
Show whether a column contains ARRAY values in the data by using the IS\_ARRAY function in a SELECT list:
