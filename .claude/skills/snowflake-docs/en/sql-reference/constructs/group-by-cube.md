...
last_scraped: '2026-01-14T16:55:01.298455+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/constructs/group-by-cube
...
[Reference](../../reference.md)[SQL command reference](../../sql-reference-commands.md)[Query syntax](../constructs.md)GROUP BY CUBE
...
GROUP BY CUBE is an extension of the [GROUP BY](group-by) clause similar to
[GROUP BY ROLLUP](group-by-rollup). In addition to producing all the rows of a
[GROUP BY ROLLUP](group-by-rollup), GROUP BY CUBE adds all the “cross-tabulations” rows. Sub-total rows are
...
See also:
:   [GROUP BY GROUPING SETS](group-by-grouping-sets) , [GROUP BY ROLLUP](group-by-rollup)
