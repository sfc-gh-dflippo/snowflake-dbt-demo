...
last_scraped: '2026-01-14T16:55:44.543324+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/sql-reference/constructs/into
title: INTO | Snowflake Documentation
---
...
[Reference](../../reference.md)[SQL command reference](../../sql-reference-commands.md)[Query syntax](../constructs.md)INTO

Categories:
:   [Query syntax](../constructs)

# INTO[¶](#into "Link to this heading")

Sets [Snowflake Scripting variables](../../developer-guide/snowflake-scripting/variables) to the values in a row returned by a
SELECT statement. See [Setting variables to the results of a SELECT statement](../../developer-guide/snowflake-scripting/variables.html#label-snowscript-variables-select-into) for details.
...
:   Specifies scalar expressions (e.g. columns in a table specified by the [FROM](from) clause).
...
See [Setting variables to the results of a SELECT statement](../../developer-guide/snowflake-scripting/variables.html#label-snowscript-variables-select-into).
