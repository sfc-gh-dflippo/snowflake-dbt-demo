---
auto_generated: true
description: The Snowpark Migration Accelerator (SMA) is primarily designed to analyze
  and convert code in scripts and notebooks. That can be from a variety of scripting
  languages, but also includes SQL. As the SM
last_scraped: '2026-01-14T16:51:27.109239+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/issue-analysis/issue-codes-by-source/sql/README
title: 'Snowpark Migration Accelerator:  SQL | Snowflake Documentation'
---
...
[Guides](../../../../../guides/README.md)[Migrations](../../../../README.md)Tools[Snowpark Migration Accelerator](../../../README.md)Issue analysis[Issue codes by source](../README.md)SQL

# Snowpark Migration Accelerator: SQL[¶](#snowpark-migration-accelerator-sql "Link to this heading")
