---
auto_generated: true
description: During your work with the Snowpark Migration Accelerator (SMA), you’ll
  frequently encounter the term “issue.” Issues are diagnostic codes that appear in
  both reports and converted code. These codes se
last_scraped: '2026-01-14T16:51:22.618359+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/issue-analysis/issue-codes-by-source/README
title: 'Snowpark Migration Accelerator:  Issue Codes by Source | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)Issue analysisIssue codes by source

# Snowpark Migration Accelerator: Issue Codes by Source[¶](#snowpark-migration-accelerator-issue-codes-by-source "Link to this heading")
...
* [Pandas Issue Codes](pandas/README)
* [Python Issue Codes](python/README)
* [Spark-Scala Issue Codes](spark-scala/README)
* [SQL Issue Codes](sql/README)
* [Snowpark Connect Python Issue Codes](python/snowpark-connect-codes-python)
* [Snowpark Connect Scala Issue Codes](spark-scala/snowpark-connect-codes-scala)
