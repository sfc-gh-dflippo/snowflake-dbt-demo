---
auto_generated: true
description: 'All the warnings, parsing errors and conversion errors generated by
  the SMA when processing Pandas elements will appear below. If you have any concerns
  or see something that’s not right, please reach '
last_scraped: '2026-01-14T16:51:24.152717+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/issue-analysis/issue-codes-by-source/pandas/README
title: 'Snowpark Migration Accelerator:  Pandas | Snowflake Documentation'
---
...
[Guides](../../../../../guides/README.md)[Migrations](../../../../README.md)Tools[Snowpark Migration Accelerator](../../../README.md)Issue analysis[Issue codes by source](../README.md)Pandas

# Snowpark Migration Accelerator: Pandas[¶](#snowpark-migration-accelerator-pandas "Link to this heading")

## Issue Codes[¶](#issue-codes "Link to this heading")

All the warnings, parsing errors and conversion errors generated by the SMA when processing Pandas elements will appear below. If you have any concerns or see something that’s not right, please reach out to the SMA support team at [sma-support@snowflake.com](mailto:sma-support%40snowflake.com).

| Code | Description | Category | Deprecated since |
| --- | --- | --- | --- |
| `PNDSPY1001` | Element is not supported | Conversion Error | - |
| `PNDSPY1002` | Element has a direct mapping with a few scenarios not supported | Warning | - |
| `PNDSPY1003` | Element is not recognized | Conversion Error | - |
