---
auto_generated: true
description: The Snowpark Migration Accelerator (SMA) converts code where possible
  and identifies sections it cannot convert. When SMA encounters code it cannot convert,
  it generates an issue with a specific issue
last_scraped: '2026-01-14T16:51:28.867216+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/issue-analysis/troubleshooting-the-output-code/locating-issues
title: 'Snowpark Migration Accelerator:  Locating Issues | Snowflake Documentation'
---
    ...
    * Tools
      ...
      * [Snowpark Migration Accelerator](../../README.md)
        ...
        + Issue analysis
          ...
          + [Troubleshooting the output code](README.md)

            - [Locating issues](locating-issues.md)
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)Issue analysis[Troubleshooting the output code](README.md)Locating issues

# Snowpark Migration Accelerator: Locating Issues[¶](#snowpark-migration-accelerator-locating-issues "Link to this heading")
...
Use the [Issues Inventory file](../../user-guide/assessment/output-reports/sma-inventories.html#issue-inventory) from your local output to review identified issues.

![Mapping issue locations](../../../../_images/image%28529%29.png)
