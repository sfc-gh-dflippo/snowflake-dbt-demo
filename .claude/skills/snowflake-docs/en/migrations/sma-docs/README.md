---
auto_generated: true
description: 'Traditional data platforms and big data solutions often fail to achieve
  their main goal: allowing users to work with data without restrictions on size,
  speed, or adaptability. Snowflake’s Data Cloud o'
last_scraped: '2026-01-14T16:51:13.447202+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/README
title: Snowpark Migration Accelerator Documentation | Snowflake Documentation
---
...
[Guides](../../guides/README.md)[Migrations](../README.md)ToolsSnowpark Migration Accelerator

# Snowpark Migration Accelerator Documentation[¶](#snowpark-migration-accelerator-documentation "Link to this heading")
