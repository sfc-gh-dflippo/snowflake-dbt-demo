---
auto_generated: true
description: While Snowflake SQL and Spark SQL share many similarities, they have
  distinct differences that require careful translation. When migrating between these
  platforms, certain SQL statements and functions
last_scraped: '2026-01-14T16:51:50.159651+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/translation-reference/spark-sql/README
title: 'Snowpark Migration Accelerator:  Spark SQL | Snowflake Documentation'
---
      ...
      * [Snowpark Migration Accelerator](../../README.md)
        ...
        + Translation reference
          ...
          + [Spark SQL](README.md)
            ...
            - [Spark SQL DML](spark-sql-dml/README.md)
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)Translation referenceSpark SQL

# Snowpark Migration Accelerator: Spark SQL[¶](#snowpark-migration-accelerator-spark-sql "Link to this heading")
...
| --- | --- |
| DDL | [spark-sql-ddl](spark-sql-ddl/README) |
| DML | [spark-sql-dml](spark-sql-dml/README) |
| Data Types | [spark-sql-data-types.md](spark-sql-data-types) |
