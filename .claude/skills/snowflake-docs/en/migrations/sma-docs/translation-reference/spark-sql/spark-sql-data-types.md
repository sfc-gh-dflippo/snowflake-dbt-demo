...
last_scraped: '2026-01-14T16:51:51.638278+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/translation-reference/spark-sql/spark-sql-data-types
title: 'Snowpark Migration Accelerator:  Spark SQL Data Types | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)Translation reference[Spark SQL](README.md)Spark SQL data types

# Snowpark Migration Accelerator: Spark SQL Data Types[¶](#snowpark-migration-accelerator-spark-sql-data-types "Link to this heading")
...
| `FLOAT` | `FLOAT` |  |
| `INTEGER` | `INTEGER` |  |
| `LONG` | `INT` | Check out [note](#integer-types) |
| `SHORT` | `INT` | Check out [note](#integer-types) |
| `STRING` | `STRING` |  |
