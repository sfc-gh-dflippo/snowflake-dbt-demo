---
auto_generated: true
description: 'While SELECT statements are common across different SQL databases, the
  way data manipulation (DML) works can vary significantly between database systems.
  Each database has its own unique features and '
last_scraped: '2026-01-14T16:51:52.634491+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/translation-reference/spark-sql/spark-sql-dml/README
title: 'Snowpark Migration Accelerator:  Spark SQL DML | Snowflake Documentation'
---
...
[Guides](../../../../../guides/README.md)[Migrations](../../../../README.md)Tools[Snowpark Migration Accelerator](../../../README.md)Translation reference[Spark SQL](../README.md)Spark SQL DML

# Snowpark Migration Accelerator: Spark SQL DML[¶](#snowpark-migration-accelerator-spark-sql-dml "Link to this heading")
