---
auto_generated: true
description: While DDL (Data Definition Language) may seem straightforward at first
  glance, each database platform has its own specific parameters and syntax. These
  platform-specific differences can create signifi
last_scraped: '2026-01-14T16:51:52.220665+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/translation-reference/spark-sql/spark-sql-ddl/README
title: 'Snowpark Migration Accelerator: Spark SQL DDL | Snowflake Documentation'
---
...
[Guides](../../../../../guides/README.md)[Migrations](../../../../README.md)Tools[Snowpark Migration Accelerator](../../../README.md)Translation reference[Spark SQL](../README.md)Spark SQL DDL

# Snowpark Migration Accelerator: Spark SQL DDL[¶](#snowpark-migration-accelerator-spark-sql-ddl "Link to this heading")
...
* [CREATE TABLE](create-table/README)
