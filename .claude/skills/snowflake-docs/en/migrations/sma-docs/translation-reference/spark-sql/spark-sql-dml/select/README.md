---
auto_generated: true
description: A SELECT statement offers multiple options to enhance your query results.
  While some of these options are directly compatible with Snowflake, others may require
  conversion or modification to work prop
last_scraped: '2026-01-14T16:51:54.104145+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/translation-reference/spark-sql/spark-sql-dml/select/README
title: 'Snowpark Migration Accelerator: SELECT | Snowflake Documentation'
---
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[Snowpark Migration Accelerator](../../../../README.md)Translation reference[Spark SQL](../../README.md)[Spark SQL DML](../README.md)SELECT

# Snowpark Migration Accelerator: SELECT[¶](#snowpark-migration-accelerator-select "Link to this heading")
