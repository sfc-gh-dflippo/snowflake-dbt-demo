---
auto_generated: true
description: 'The Snowpark Migration Accelerator (SMA) converts source code into Snowflake-compatible
  formats. This section explains which elements and formats are compatible with Snowflake,
  helping you understand '
last_scraped: '2026-01-14T16:51:50.946663+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/translation-reference/translation-reference-overview
title: 'Snowpark Migration Accelerator:  Translation Reference Overview | Snowflake
  Documentation'
---
...
[Guides](../../../guides/README.md)[Migrations](../../README.md)Tools[Snowpark Migration Accelerator](../README.md)Translation referenceTranslation reference overview

# Snowpark Migration Accelerator: Translation Reference Overview[¶](#snowpark-migration-accelerator-translation-reference-overview "Link to this heading")
...
This reference guide is continuously updated, and your feedback is valuable for its improvement. You can help enhance the mappings or add comments by using the [report an issue option](../user-guide/project-overview/configuration-and-settings.html#report-an-issue) in the SMA.
