---
auto_generated: true
description: A known issue exists on macOS where SMA crashes if the project directory
  lacks proper read and write permissions.
last_scraped: '2026-01-14T16:51:37.187270+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/support/general-troubleshooting/how-do-i-give-sma-permission-to-documents-desktop-and-downloads-folders
title: 'Snowpark Migration Accelerator:  How do I give SMA permission to Documents,
  Desktop, and Downloads folders? | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)Support[General troubleshooting](README.md)How do I give SMA permission to documents desktop and downloads folders?

# Snowpark Migration Accelerator: How do I give SMA permission to Documents, Desktop, and Downloads folders?[¶](#snowpark-migration-accelerator-how-do-i-give-sma-permission-to-documents-desktop-and-downloads-folders "Link to this heading")
