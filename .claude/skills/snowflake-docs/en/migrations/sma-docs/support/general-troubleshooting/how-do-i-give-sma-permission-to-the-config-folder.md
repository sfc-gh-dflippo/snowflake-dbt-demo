---
auto_generated: true
description: 'SMA requires specific folder permissions to function correctly. It needs
  read, write, and execute access to:'
last_scraped: '2026-01-14T16:51:37.553365+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/support/general-troubleshooting/how-do-i-give-sma-permission-to-the-config-folder
title: 'Snowpark Migration Accelerator: How do I give SMA permission to the config
  folder? | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)Support[General troubleshooting](README.md)How do I give SMA permission to the config folder?

# Snowpark Migration Accelerator: How do I give SMA permission to the config folder?[¶](#snowpark-migration-accelerator-how-do-i-give-sma-permission-to-the-config-folder "Link to this heading")
...
## For macOS[¶](#for-macos "Link to this heading")
...
### For Windows[¶](#for-windows "Link to this heading")
...
![image (17).png](../../../../_images/image%2817%29.png)
