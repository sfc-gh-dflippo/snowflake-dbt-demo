---
auto_generated: true
description: This problem only affects macOS systems.
last_scraped: '2026-01-14T16:51:36.848319+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/support/general-troubleshooting/how-do-I-make-sure-that-config-is-folder
title: 'Snowpark Migration Accelerator: How do I make sure that .config is a folder
  instead of a file? | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)Support[General troubleshooting](README.md)How do I make sure that .config is a folder instead of a file?

# Snowpark Migration Accelerator: How do I make sure that .config is a folder instead of a file?[¶](#snowpark-migration-accelerator-how-do-i-make-sure-that-config-is-a-folder-instead-of-a-file "Link to this heading")

*This problem only affects macOS systems.*

![The modal shown when .config is a file instead of a folder](../../../../_images/permission-denied-write-folder.png)
