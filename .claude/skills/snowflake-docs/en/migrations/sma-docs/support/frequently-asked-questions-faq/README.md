---
auto_generated: true
description: Looking for help with Snowpark Migration Accelerator for Python? Here
  are the most common questions and answers about SMA for PySpark to help you get
  started.
last_scraped: '2026-01-14T16:51:29.586424+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/support/frequently-asked-questions-faq/README
title: 'Snowpark Migration Accelerator:  Frequently Asked Questions (FAQ) | Snowflake
  Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)SupportFrequently asked questions

# Snowpark Migration Accelerator: Frequently Asked Questions (FAQ)[¶](#snowpark-migration-accelerator-frequently-asked-questions-faq "Link to this heading")
...
* [Using SMA with Jupyter Notebooks](using-sma-with-jupyter-notebooks)
* [How to obtain your access code](how-to-request-an-access-code)
* [How to share results with Snowflake](sharing-the-output-with-snowflake)
* [Working with DBC file extraction](dbc-files-explode)
