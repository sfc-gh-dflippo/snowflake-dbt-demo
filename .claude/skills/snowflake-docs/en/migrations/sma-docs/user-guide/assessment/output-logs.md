---
auto_generated: true
description: The Snowpark Migration Accelerator (SMA) creates detailed log files during
  its execution. These logs track the tool’s operations and are valuable resources
  for troubleshooting when issues occur.
last_scraped: '2026-01-14T16:51:45.416859+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/user-guide/assessment/output-logs
title: 'Snowpark Migration Accelerator: Output Logs | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)User guide[Assessment](README.md)Output logs

# Snowpark Migration Accelerator: Output Logs[¶](#snowpark-migration-accelerator-output-logs "Link to this heading")
...
If you are experiencing issues with the Snowpark Migration Accelerator (SMA) and need to analyze the logs, please visit [the Support section](../../support/general-troubleshooting/README) of our documentation or contact our support team directly at [sma-support@snowflake.com](mailto:sma-support%40snowflake.com).
