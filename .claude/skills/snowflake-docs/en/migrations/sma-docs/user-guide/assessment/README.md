---
auto_generated: true
description: The Snowpark Migration Accelerator (SMA) begins with a comprehensive
  assessment of your environment. Understanding the assessment process is essential
  to maximize its benefits and ensure successful mi
last_scraped: '2026-01-14T16:51:38.426066+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/user-guide/assessment/README
title: 'Snowpark Migration Accelerator: Assessment | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)User guideAssessment

# Snowpark Migration Accelerator: Assessment[¶](#snowpark-migration-accelerator-assessment "Link to this heading")

The Snowpark Migration Accelerator (SMA) begins with a comprehensive assessment of your environment. Understanding the assessment process is essential to maximize its benefits and ensure successful migration.

This section covers the following topics:

* [Detailed Guide to Output Reports](output-reports/README)
* [Understanding Readiness Scores](readiness-scores)
* [Spark Reference Categories Guide](spark-reference-categories)
* [Getting Started with Assessment](assessment-quick-start)
* [How the Assessment Works](how-the-assessment-works)
* [Understanding Your Assessment Results](understanding-the-assessment-summary)
* [Understanding Output Logs](output-logs)

The following additional topics may be helpful for reference, although they are not directly related to the assessment:

* [Issue Analysis](../../issue-analysis/approach)
