---
auto_generated: true
description: The Snowpark Migration Accelerator (SMA) analyzes your source code and
  creates a detailed inventory of all its components and dependencies.
last_scraped: '2026-01-14T16:51:45.016208+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/user-guide/assessment/how-the-assessment-works
title: 'Snowpark Migration Accelerator: How the Assessment Works | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)User guide[Assessment](README.md)How the assessment works

# Snowpark Migration Accelerator: How the Assessment Works[¶](#snowpark-migration-accelerator-how-the-assessment-works "Link to this heading")
...
[As mentioned previously](../../general/introduction), the Snowpark Migration Accelerator (SMA) is more sophisticated than a simple pattern-matching or text replacement tool. It analyzes your source code and creates a comprehensive semantic model that captures all the functionality of your codebase.
...
* [Readiness score](../../support/glossary)
...
To view all output files generated during assessment mode, please refer to [the output reports section](output-reports/README) of this documentation.
