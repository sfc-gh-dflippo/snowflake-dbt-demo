---
auto_generated: true
description: The Snowpark Migration Accelerator (SMA) processes all files within a
  specified directory. While it creates an inventory of every file, it specifically
  analyzes files with certain extensions to identi
last_scraped: '2026-01-14T16:51:56.510811+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/user-guide/before-using-the-sma/code-extraction
title: 'Snowpark Migration Accelerator:  Code Extraction | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)User guide[Before using the SMA](README.md)Code extraction

# Snowpark Migration Accelerator: Code Extraction[¶](#snowpark-migration-accelerator-code-extraction "Link to this heading")
...
## Extraction Scripts[¶](#extraction-scripts "Link to this heading")
...
1. [Extraction Scripts](#extraction-scripts)