...
description: The Snowpark Migration Accelerator (SMA) helps developers analyze and
  convert code by providing automated tools and features.
last_scraped: '2026-01-14T16:51:38.871163+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/user-guide/before-using-the-sma/README
title: 'Snowpark Migration Accelerator: Before Using the SMA | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)User guideBefore using the SMA

# Snowpark Migration Accelerator: Before Using the SMA[¶](#snowpark-migration-accelerator-before-using-the-sma "Link to this heading")
...
NOTE: Before using the Snowpark Migration Accelerator (SMA), we recommend that you familiarize yourself with its functionality and how to interpret its results. Please review the training materials and resources available on [the getting started page](../../general/getting-started/README) to learn how to use the tool effectively.
...
* [**Supported File Types**](supported-filetypes)
* [**Code Extraction Process**](code-extraction)
* [**Pre-Processing Guidelines**](pre-processing-considerations)
