---
auto_generated: true
description: The Snowpark Migration Accelerator (SMA) helps developers analyze and
  convert existing Spark code to Snowpark code. This tool simplifies the process of
  understanding your codebase and automatically tr
last_scraped: '2026-01-14T16:51:40.385794+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/user-guide/project-overview/README
title: 'Snowpark Migration Accelerator:  Project Overview | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)User guideProject overview

# Snowpark Migration Accelerator: Project Overview[¶](#snowpark-migration-accelerator-project-overview "Link to this heading")
...
* [Project Creation and Setup](project-setup)
* [Configuration and Settings](configuration-and-settings)
* [Running the Tool](tool-execution)
...
## What is a SnowConvert Project?[¶](#what-is-a-snowconvert-project "Link to this heading")
...
## What is the Readiness Score?[¶](#what-is-the-readiness-score "Link to this heading")
...
For additional technical terms and definitions, please refer to our [glossary](../../support/glossary).
...
1. [What is a SnowConvert Project?](#what-is-a-snowconvert-project)
2. [What is the Readiness Score?](#what-is-the-readiness-score)