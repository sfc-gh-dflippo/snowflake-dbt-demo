---
auto_generated: true
description: 'The Snowpark Migration Accelerator (SMA) provides optional parameters
  that help you customize how your source code is assessed or converted. Here’s a
  detailed explanation of all additional parameters '
last_scraped: '2026-01-14T16:52:10.628987+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/user-guide/using-the-sma-cli/additional-parameters
title: 'Snowpark Migration Accelerator:  Additional Parameters | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)User guide[Using the SMA CLI](README.md)Additional parameters

# Snowpark Migration Accelerator: Additional Parameters[¶](#snowpark-migration-accelerator-additional-parameters "Link to this heading")
...
## `--mapDirectory, -m <PATH>`[¶](#mapdirectory-m-path "Link to this heading")
...
### `--sqlDirectory, -f <PATH>`[¶](#sqldirectory-f-path "Link to this heading")
...
1. [--mapDirectory, -m <PATH>](#mapdirectory-m-path)