---
auto_generated: true
description: The SMA conversion process generates an Output folder containing the
  converted code. This folder becomes available immediately after the conversion is
  complete.
last_scraped: '2026-01-14T16:52:01.699114+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/user-guide/conversion/output-code
title: 'Snowpark Migration Accelerator:  Output Code | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)User guide[Conversion](README.md)Output code

# Snowpark Migration Accelerator: Output Code[¶](#snowpark-migration-accelerator-output-code "Link to this heading")
...
## Output Code File Structure[¶](#output-code-file-structure "Link to this heading")
...
![Output Directory File Structure](../../../../_images/image%28525%29.png)

When you click “View Output” in the Conversion Results Page, you will be directed to the Output folder within the Conversion-Date-Time directory. (While this folder also exists in the Assessment-Date-Time directory, it only contains demo code. For more information about demo code, please refer to the [Sample Project section](../../use-cases/sample-project) of this documentation.)
...
If checkpoints generation is enabled in the settings page (check [Conversion Settings](../project-overview/configuration-and-settings.html#conversion-settings)), the conversion will create a file in the output named “checkpoints.json” which allows the user to run it using checkpoints feature within the VS Code Snowflake Extension.
...
1. [Output Code File Structure](#output-code-file-structure)