---
auto_generated: true
description: The Workspace Estimator (WE) is a tool that helps users understand how
  they are using their cloud workspace. This information can then be shared with Snowflake
  to compare current usage patterns with p
last_scraped: '2026-01-14T16:52:11.338845+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/workspace-estimator/overview
title: 'Snowpark Migration Accelerator: Overview of the Workspace Estimator | Snowflake
  Documentation'
---
...
[Guides](../../../guides/README.md)[Migrations](../../README.md)Tools[Snowpark Migration Accelerator](../README.md)Workspace estimatorOverview

# Snowpark Migration Accelerator: Overview of the Workspace Estimator[¶](#snowpark-migration-accelerator-overview-of-the-workspace-estimator "Link to this heading")

The Workspace Estimator (WE) is a tool that helps users understand how they are using their cloud workspace. This information can then be shared with Snowflake to compare current usage patterns with potential Snowpark implementation.

This tool is in early development, and we will provide more details soon. For additional information, please contact sma-support@snowflake.com.
