---
auto_generated: true
description: This page is currently being developed. For more information about the
  Workspace Estimator, please contact sma-support@snowflake.com.
last_scraped: '2026-01-14T16:52:11.094928+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/workspace-estimator/getting-started
title: 'Snowpark Migration Accelerator:  Getting Started with the Workspace Estimator
...
[Guides](../../../guides/README.md)[Migrations](../../README.md)Tools[Snowpark Migration Accelerator](../README.md)Workspace estimatorGetting started

# Snowpark Migration Accelerator: Getting Started with the Workspace Estimator[¶](#snowpark-migration-accelerator-getting-started-with-the-workspace-estimator "Link to this heading")

This page is currently being developed. For more information about the Workspace Estimator, please contact [sma-support@snowflake.com](mailto:sma-support%40snowflake.com).
