---
auto_generated: true
description: Getting started with a migration project can be challenging. The Snowpark
  Migration Accelerator (SMA) simplifies this process by automatically analyzing your
  code and converting it to Snowpark, making
last_scraped: '2026-01-14T16:51:06.583073+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/general/getting-started/README
title: 'Snowpark Migration Accelerator: Getting Started | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)GeneralGetting started

# Snowpark Migration Accelerator: Getting Started[¶](#snowpark-migration-accelerator-getting-started "Link to this heading")
...
* [**Downloading and Getting Access**](download-and-access)
* [**Installation**](installation/README)

Already installed? Here are some helpful resources to get you started:

* [**User Guide**](../../user-guide/overview) - Learn how to use the Snowpark Migration Accelerator.
* [**Snowflake SMA Training**](https://learn.snowflake.com/en/courses/OD-SC-SMA/) - Official Snowflake training course for SMA.
* [**Assessment Walkthrough**](../../use-cases/assessment-walkthrough/README) - Step-by-step guide for conducting a migration assessment. We recommend performing an assessment before starting conversion.

  + [**Assessment Quick Start**](../../user-guide/assessment/assessment-quick-start) - Quick guide to start your assessment immediately.
  + [**Assessment Overview [Video]**](https://www.youtube.com/watch?v=78Ks4kxj3KI) - Brief video tutorial on running an assessment.
* [**Conversion Guide**](../../user-guide/conversion/README) - Complete guide for code conversion.

  + [**Conversion Quick Start**](../../user-guide/conversion/conversion-quick-start) - Begin your code conversion process.
