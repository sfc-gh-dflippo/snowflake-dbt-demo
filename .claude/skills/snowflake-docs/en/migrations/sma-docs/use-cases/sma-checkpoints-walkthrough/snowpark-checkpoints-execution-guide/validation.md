---
auto_generated: true
description: 'To proceed with the validation process, follow the steps outlined below:'
last_scraped: '2026-01-14T16:52:08.673233+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/use-cases/sma-checkpoints-walkthrough/snowpark-checkpoints-execution-guide/validation
title: 'Snowpark Migration Accelerator: Validation | Snowflake Documentation'
---
...
[Guides](../../../../../guides/README.md)[Migrations](../../../../README.md)Tools[Snowpark Migration Accelerator](../../../README.md)Use casesSnowflake VS Code extension[SMA checkpoints walkthrough](../README.md)[Snowpark-checkpoints execution guide](README.md)Validation

# Snowpark Migration Accelerator: Validation[¶](#snowpark-migration-accelerator-validation "Link to this heading")
...
1. Copy the `snowpark-checkpoints-output` folder, generated during the collection process, into the validation workload.
   ...
   ![Copying collection process output into the validation workload](../../../../../_images/image%28581%29.png)
2. Open the validation workload in VS Code to begin the validation process.

   ![Validation Workload](../../../../../_images/image%28582%29.png)
...
![File with checkpoints](../../../../../_images/image%28583%29.png)

4. Run the Python file to execute the checkpoints validation process.

When running a python file that contains validation checkpoints, the validation results are going to be shown in the copied “snowpark-checkpoints-output” folder as “checkpoints\_validation\_results.json”:

![Results](../../../../../_images/image%28584%29.png)

The “checkpoints\_validation\_results.json” contains the unified results of the collection process
