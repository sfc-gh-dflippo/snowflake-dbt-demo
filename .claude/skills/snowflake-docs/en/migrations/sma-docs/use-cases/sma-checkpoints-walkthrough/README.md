---
auto_generated: true
description: The Snowpark Migration Accelerator provides the SMA-Checkpoints feature,
  this feature goal is to be used within the checkpoints feature of the Snowflake
  Extension. SMA Checkpoints can be either enable
last_scraped: '2026-01-14T16:51:35.517269+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/use-cases/sma-checkpoints-walkthrough/README
title: 'Snowpark Migration Accelerator: SMA Checkpoints walkthrough | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)Use casesSnowflake VS Code extensionSMA checkpoints walkthrough

# Snowpark Migration Accelerator: SMA Checkpoints walkthrough[¶](#snowpark-migration-accelerator-sma-checkpoints-walkthrough "Link to this heading")
...
![SMA-Checkpoints Workflow](../../../../_images/image%28585%29.png)

## Feature limitations[¶](#feature-limitations "Link to this heading")
...
1. [Feature limitations](#feature-limitations)
