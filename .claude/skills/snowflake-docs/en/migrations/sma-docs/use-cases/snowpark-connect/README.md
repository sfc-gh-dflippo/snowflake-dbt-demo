---
auto_generated: true
description: Snowpark Connect for Spark allows you to run some Spark workflows in
  Snowflake with minimal changes.
last_scraped: '2026-01-14T16:51:33.366464+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/use-cases/snowpark-connect/README
title: 'Snowpark Migration Accelerator: Snowpark Connect | Snowflake Documentation'
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[Snowpark Migration Accelerator](../../README.md)Use casesSnowpark Connect

# Snowpark Migration Accelerator: Snowpark Connect[¶](#snowpark-migration-accelerator-snowpark-connect "Link to this heading")

[Snowpark Connect for Spark](../../../../developer-guide/snowpark-connect/snowpark-connect-overview) allows you to run some Spark workflows in Snowflake with minimal changes.
