---
auto_generated: true
description: The Snowpark Migration Accelerator (SMA) can be run in conversion mode
  to generate output code that is compatible with Snowflake. This lab will walk you
  through executing a conversion and help you bet
last_scraped: '2026-01-14T16:51:34.454744+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/use-cases/conversion-walkthrough
title: 'Snowpark Migration Accelerator:  Conversion Walkthrough | Snowflake Documentation'
---
...
[Guides](../../../guides/README.md)[Migrations](../../README.md)Tools[Snowpark Migration Accelerator](../README.md)Use casesConversion walkthrough

# Snowpark Migration Accelerator: Conversion Walkthrough[¶](#snowpark-migration-accelerator-conversion-walkthrough "Link to this heading")
...
The Conversion Walkthrough has been absorbed by [the Migration Lab in the next section](migration-lab/README).
