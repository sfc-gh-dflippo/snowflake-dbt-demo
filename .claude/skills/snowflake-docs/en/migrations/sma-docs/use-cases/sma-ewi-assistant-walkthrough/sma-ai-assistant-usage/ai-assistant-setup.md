---
auto_generated: true
description: Install the Snowflake VS Code extension.
last_scraped: '2026-01-14T16:51:31.404698+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/use-cases/sma-ewi-assistant-walkthrough/sma-ai-assistant-usage/ai-assistant-setup
title: AI Assistant setup | Snowflake Documentation
---
...
[Guides](../../../../../guides/README.md)[Migrations](../../../../README.md)Tools[Snowpark Migration Accelerator](../../../README.md)Use casesSnowflake VS Code extension[SMA EWI Assistant walkthrough](../README.md)[SMA AI assistant usage](README.md)AI Assistant Setup

# AI Assistant setup[¶](#ai-assistant-setup "Link to this heading")

1. Install the Snowflake VS Code extension.

   ![Install extension](../../../../../_images/install-snowflake-extension.png)
2. Open the extension’s settings.

   ![Open settings](../../../../../_images/open-extension-settings.png)
3. Search for and enable the **Snowpark Migration Accelerator AI Assistant**.

   ![Enable accelerator AI assistant](../../../../../_images/enable-assistant.png)
