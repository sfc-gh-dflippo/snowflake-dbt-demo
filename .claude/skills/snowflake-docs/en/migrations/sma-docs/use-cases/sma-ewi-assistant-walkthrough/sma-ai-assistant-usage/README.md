---
auto_generated: true
description: 'To ensure correct usage of the SMA AI Assistant, please follow these
  steps:'
last_scraped: '2026-01-14T16:51:30.621325+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/sma-docs/use-cases/sma-ewi-assistant-walkthrough/sma-ai-assistant-usage/README
title: SMA AI Assistant Usage | Snowflake Documentation
---
        ...
        + Use cases
          ...
          + Snowflake VS Code extension
            ...
            + [SMA EWI Assistant walkthrough](../README.md)
              ...
              - [SMA AI assistant usage](README.md)
...
[Guides](../../../../../guides/README.md)[Migrations](../../../../README.md)Tools[Snowpark Migration Accelerator](../../../README.md)Use casesSnowflake VS Code extension[SMA EWI Assistant walkthrough](../README.md)SMA AI assistant usage

# SMA AI Assistant Usage[¶](#sma-ai-assistant-usage "Link to this heading")

To ensure correct usage of the SMA AI Assistant, please follow these steps:

1. Open VS Code.
2. Follow the steps in the [AI Assistant Setup](ai-assistant-setup) section.
3. Open the migration output folder in VS Code.

   ![](../../../../../_images/output-folder.png)
...
6. View the SMA EWI Assistant code lens.
   ...
   1. Click the SMA AI Assistant code lens to open a window providing explanations and resolutions for the EWI.
      ...
      ![](../../../../../_images/explanations-resolutions.png)
...
8. View the EWI explanation and responses.
   ...
   ![](../../../../../_images/explanations-responses-view.png)
9. Follow the assistant responses.

   ![](../../../../../_images/assistant-responses.png)
