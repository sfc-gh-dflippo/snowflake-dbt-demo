...
last_scraped: '2026-01-14T16:52:50.729225+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/technical-documentation/issues-and-troubleshooting/functional-difference/sqlServerFDM
title: SnowConvert AI - SQL Server-Azure Synapse Functional Differences | Snowflake
  Documentation
---
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)General[Technical Documentation](../../README.md)[Issues And Troubleshooting](../README.md)[Functional Difference](README.md)SQL Server-Azure Synapse

# SnowConvert AI - SQL Server-Azure Synapse Functional Differences[¶](#snowconvert-ai-sql-server-azure-synapse-functional-differences "Link to this heading")
...
## SSC-FDM-TS0001[¶](#ssc-fdm-ts0001 "Link to this heading")

Note

This FDM is deprecated, please refer to [SSC-EWI-TS0077](../conversion-issues/sqlServerEWI.html#ssc-ewi-ts0077) documentation
...
## SSC-FDM-TS0002[¶](#ssc-fdm-ts0002 "Link to this heading")
...
## SSC-FDM-TS0003[¶](#ssc-fdm-ts0003 "Link to this heading")
...
## SSC-FDM-TS0004[¶](#ssc-fdm-ts0004 "Link to this heading")
...
#### Code Example[¶](#id11 "Link to this heading")
...
## SSC-FDM-TS0005[¶](#ssc-fdm-ts0005 "Link to this heading")

TRY\_CONVERT/TRY\_CAST could not be converted to TRY\_CAST

### Description[¶](#id15 "Link to this heading")

This FMD is added when a TRY\_CONVERT or TRY\_CAST cannot be converted to a TRY\_CAST in Snowflake.
...
#### Code Example[¶](#id16 "Link to this heading")
...
## SSC-FDM-TS0006[¶](#ssc-fdm-ts0006 "Link to this heading")
...
#### Code Example[¶](#id21 "Link to this heading")
...
## SSC-FDM-TS0007[¶](#ssc-fdm-ts0007 "Link to this heading")
...
#### Code Example[¶](#id26 "Link to this heading")
...
## SSC-FDM-TS0008[¶](#ssc-fdm-ts0008 "Link to this heading")
...
In the FORMATMESSAGE\_UDF, a error will happen if the given number of arguments is different than the number of placeholders.
...
## SSC-FDM-TS0009[¶](#ssc-fdm-ts0009 "Link to this heading")
...
## SSC-FDM-TS0010[¶](#ssc-fdm-ts0010 "Link to this heading")
...
## SSC-FDM-TS0011[¶](#ssc-fdm-ts0011 "Link to this heading")

Default value not allowed in Snowflake.

Note

This FDM is deprecated, please refer to [SSC-EWI-TS0078](../conversion-issues/sqlServerEWI.html#ssc-ewi-ts0078) documentation
...
#### Code Example[¶](#id46 "Link to this heading")
...
##### [¶](#id49 "Link to this heading")

#### Best Practices[¶](#id50 "Link to this heading")

* If you need more support, you can email us at [snowconvert-support@snowflake.com](mailto:snowconvert-support%40snowflake.com)

## SSC-FDM-TS0012[¶](#ssc-fdm-ts0012 "Link to this heading")
...
#### Code Example[¶](#id52 "Link to this heading")

##### Input Code:[¶](#id53 "Link to this heading")
...
##### Generated Code:[¶](#id54 "Link to this heading")
...
#### Best Practices[¶](#id55 "Link to this heading")
...
## SSC-FDM-TS0013[¶](#ssc-fdm-ts0013 "Link to this heading")
...
#### Example Code:[¶](#id57 "Link to this heading")
...
##### Generated Code:[¶](#id59 "Link to this heading")
...
## SSC-FDM-TS0014[¶](#ssc-fdm-ts0014 "Link to this heading")
...
## SSC-FDM-TS0016[¶](#ssc-fdm-ts0016 "Link to this heading")
...
#### Code Example[¶](#id67 "Link to this heading")
...
##### Code[¶](#id70 "Link to this heading")
...
##### Output[¶](#id71 "Link to this heading")
...
#### Best Practices[¶](#id72 "Link to this heading")

* No additional user actions are required; it is just informative.
* If you need more support, you can email us at [snowconvert-support@snowflake.com](mailto:snowconvert-support%40snowflake.com)

## SSC-FDM-TS0017[¶](#ssc-fdm-ts0017 "Link to this heading")
...
## SSC-FDM-TS0018[¶](#ssc-fdm-ts0018 "Link to this heading")

Database console command is not supported

Note

This FDM is deprecated, please refer to [SSC-EWI-TS0079](../conversion-issues/sqlServerEWI.html#ssc-ewi-ts0079) documentation

### Description[¶](#id77 "Link to this heading")

This FMD is added when SnowConvert AI finds a DBCC statement inside the input code.  
Most DBCC statements are not supported in Snowflake.

#### Code Example[¶](#id78 "Link to this heading")
...
## SSC-FDM-TS0019[¶](#ssc-fdm-ts0019 "Link to this heading")
...
#### Code Example[¶](#id83 "Link to this heading")
...
## SSC-FDM-TS0020[¶](#ssc-fdm-ts0020 "Link to this heading")
...
Currently, support for that constraint is unavailable. A workaround to transform it is to define the table prior to using Alter Table. This allows SnowConvert AI to identify the references, and the default constraint is consolidated in the table definition. Otherwise, the constraint is only commented out.

#### Code Example[¶](#id88 "Link to this heading")
...
## SSC-FDM-TS0021[¶](#ssc-fdm-ts0021 "Link to this heading")
...
#### Code Example[¶](#id93 "Link to this heading")
...
## SSC-FDM-TS0022[¶](#ssc-fdm-ts0022 "Link to this heading")
...
#### Code Example[¶](#id98 "Link to this heading")
...
##### Generated Code:[¶](#id100 "Link to this heading")
...
## SSC-FDM-TS0023[¶](#ssc-fdm-ts0023 "Link to this heading")
...
#### Generated Code[¶](#id104 "Link to this heading")
...
## SSC-FDM-TS0024[¶](#ssc-fdm-ts0024 "Link to this heading")
...
##### Generated Code:[¶](#id107 "Link to this heading")
...
##### SQL Server[¶](#id110 "Link to this heading")
...
## SSC-FDM-TS0025[¶](#ssc-fdm-ts0025 "Link to this heading")
...
##### Sql Server[¶](#id116 "Link to this heading")
...
## SSC-FDM-TS0027[¶](#ssc-fdm-ts0027 "Link to this heading")
...
#### Input Code[¶](#id129 "Link to this heading")
...
##### Generated Code[¶](#id130 "Link to this heading")
...
#### Best Practices[¶](#id131 "Link to this heading")

* If you need more support, you can email us at [snowconvert-support@snowflake.com](mailto:snowconvert-support%40snowflake.com)

## SSC-FDM-TS0028[¶](#ssc-fdm-ts0028 "Link to this heading")
...
#### Correct case[¶](#correct-case "Link to this heading")
...
#### Problematic case[¶](#problematic-case "Link to this heading")
...
##### Transact[¶](#id135 "Link to this heading")
...
## SSC-FDM-TS0029[¶](#ssc-fdm-ts0029 "Link to this heading")
...
### Code example[¶](#id139 "Link to this heading")
...
## SSC-FDM-TS0030[¶](#ssc-fdm-ts0030 "Link to this heading")
...
### Code example[¶](#id144 "Link to this heading")

#### Input Code:[¶](#id145 "Link to this heading")
...
##### Generated Code[¶](#id146 "Link to this heading")
...
### Best Practices[¶](#id147 "Link to this heading")

* If you need more support, you can email us at [snowconvert-support@snowflake.com](mailto:snowconvert-support%40snowflake.com)

## SSC-FDM-TS0031[¶](#ssc-fdm-ts0031 "Link to this heading")

SET ANSI\_WARNINGS ON statement is commented out, which Snowflake generally adheres to ANSI-standard behaviors.
...
### Code example[¶](#id149 "Link to this heading")

#### Input Code:[¶](#id150 "Link to this heading")
...
##### Generated Code[¶](#id151 "Link to this heading")
...
### Best Practices[¶](#id152 "Link to this heading")

* If you need more support, you can email us at [snowconvert-support@snowflake.com](mailto:snowconvert-support%40snowflake.com)

## SSC-FDM-TS0032[¶](#ssc-fdm-ts0032 "Link to this heading")
...
### Code example[¶](#id154 "Link to this heading")

#### Input Code:[¶](#id155 "Link to this heading")
...
### Best Practices[¶](#id157 "Link to this heading")

* If you need more support, you can email us at [snowconvert-support@snowflake.com](mailto:snowconvert-support%40snowflake.com)

## SSC-FDM-TS0033[¶](#ssc-fdm-ts0033 "Link to this heading")
...
In SQL Server, SET QUOTED\_IDENTIFIER ON is a syntax setting that is separate from collation. The database’s or column’s collation (e.g., \_CI for Case-Insensitive or \_CS for Case-Sensitive) dictates whether quoted identifiers are case-sensitive or not. If a database has a \_CI collation, then “MyColumn” and “mycolumn” are treated as the same.
...
### Code example[¶](#id159 "Link to this heading")
...
### Best Practices[¶](#id162 "Link to this heading")

* If you need more support, you can email us at [snowconvert-support@snowflake.com](mailto:snowconvert-support%40snowflake.com)

## SSC-FDM-TS0034[¶](#ssc-fdm-ts0034 "Link to this heading")
...
### Example Code[¶](#id164 "Link to this heading")
...
#### Output (Snowflake):[¶](#output-snowflake "Link to this heading")
...
1. [SSC-FDM-TS0001](#ssc-fdm-ts0001)
2. [SSC-FDM-TS0002](#ssc-fdm-ts0002)
3. [SSC-FDM-TS0003](#ssc-fdm-ts0003)
4. [SSC-FDM-TS0004](#ssc-fdm-ts0004)
5. [SSC-FDM-TS0005](#ssc-fdm-ts0005)
6. [SSC-FDM-TS0006](#ssc-fdm-ts0006)
7. [SSC-FDM-TS0007](#ssc-fdm-ts0007)
8. [SSC-FDM-TS0008](#ssc-fdm-ts0008)
9. [SSC-FDM-TS0009](#ssc-fdm-ts0009)
10. [SSC-FDM-TS0010](#ssc-fdm-ts0010)
11. [SSC-FDM-TS0011](#ssc-fdm-ts0011)
12. [SSC-FDM-TS0012](#ssc-fdm-ts0012)
13. [SSC-FDM-TS0013](#ssc-fdm-ts0013)
14. [SSC-FDM-TS0014](#ssc-fdm-ts0014)
15. [SSC-FDM-TS0016](#ssc-fdm-ts0016)
16. [SSC-FDM-TS0017](#ssc-fdm-ts0017)
17. [SSC-FDM-TS0018](#ssc-fdm-ts0018)
18. [SSC-FDM-TS0019](#ssc-fdm-ts0019)
19. [SSC-FDM-TS0020](#ssc-fdm-ts0020)
20. [SSC-FDM-TS0021](#ssc-fdm-ts0021)
21. [SSC-FDM-TS0022](#ssc-fdm-ts0022)
22. [SSC-FDM-TS0023](#ssc-fdm-ts0023)
23. [SSC-FDM-TS0024](#ssc-fdm-ts0024)
24. [SSC-FDM-TS0025](#ssc-fdm-ts0025)
25. [SSC-FDM-TS0026](#ssc-fdm-ts0026)
26. [SSC-FDM-TS0027](#ssc-fdm-ts0027)
27. [SSC-FDM-TS0028](#ssc-fdm-ts0028)
28. [SSC-FDM-TS0029](#ssc-fdm-ts0029)
29. [SSC-FDM-TS0030](#ssc-fdm-ts0030)
30. [SSC-FDM-TS0031](#ssc-fdm-ts0031)
31. [SSC-FDM-TS0032](#ssc-fdm-ts0032)
32. [SSC-FDM-TS0033](#ssc-fdm-ts0033)
33. [SSC-FDM-TS0034](#ssc-fdm-ts0034)