...
last_scraped: '2026-01-14T16:52:44.558651+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/technical-documentation/issues-and-troubleshooting/conversion-issues/ssisEWI
title: SnowConvert AI - SSIS Conversion Issues | Snowflake Documentation
---
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)General[Technical Documentation](../../README.md)[Issues And Troubleshooting](../README.md)[Conversion Issues](README.md)SSIS Issues

# SnowConvert AI - SSIS Conversion Issues[¶](#snowconvert-ai-ssis-conversion-issues "Link to this heading")
...
For assistance with any EWI, you can use the [SnowConvert Migration Assistant](../../../../migration-assistant/README) to get AI-powered explanations and actionable solutions, or contact [snowconvert-support@snowflake.com](mailto:snowconvert-support%40snowflake.com) for additional support.

## SSC-EWI-SSIS0001[¶](#ssc-ewi-ssis0001 "Link to this heading")
...
### Converted Code[¶](#converted-code "Link to this heading")
...
* Use the [SnowConvert Migration Assistant](../../../../migration-assistant/README) to get AI-powered explanations and actionable solutions for this EWI
...
## SSC-EWI-SSIS0002[¶](#ssc-ewi-ssis0002 "Link to this heading")
...
### Converted Code[¶](#id3 "Link to this heading")
...
### Best Practices[¶](#id4 "Link to this heading")
...
## SSC-EWI-SSIS0003[¶](#ssc-ewi-ssis0003 "Link to this heading")

Embedded SQL requires manual translation to Snowflake syntax.

### Severity[¶](#id5 "Link to this heading")
...
### Converted Code[¶](#id7 "Link to this heading")
...
## SSC-EWI-SSIS0004[¶](#ssc-ewi-ssis0004 "Link to this heading")

SSIS Control Flow Element requires manual implementation.

### Severity[¶](#id8 "Link to this heading")
...
#### For Loop Container[¶](#for-loop-container "Link to this heading")
...
#### ForEach Loop Container (Non-File Enumerator)[¶](#foreach-loop-container-non-file-enumerator "Link to this heading")
...
#### Other Unsupported Control Flow Elements[¶](#other-unsupported-control-flow-elements "Link to this heading")
...
## SSC-EWI-SSIS0005[¶](#ssc-ewi-ssis0005 "Link to this heading")
...
### Converted Code[¶](#id12 "Link to this heading")
...
## SSC-EWI-SSIS0006[¶](#ssc-ewi-ssis0006 "Link to this heading")
...
### Converted Code[¶](#id15 "Link to this heading")
...
## SSC-EWI-SSIS0007[¶](#ssc-ewi-ssis0007 "Link to this heading")
...
### Converted Code[¶](#id18 "Link to this heading")
...
## SSC-EWI-SSIS0008[¶](#ssc-ewi-ssis0008 "Link to this heading")

Execute Package Task references external package not in conversion scope.

### Severity[¶](#id20 "Link to this heading")
...
### Converted Code[¶](#id22 "Link to this heading")
...
## SSC-EWI-SSIS0009[¶](#ssc-ewi-ssis0009 "Link to this heading")
...
### Converted Code[¶](#id26 "Link to this heading")
...
## SSC-EWI-SSIS0010[¶](#ssc-ewi-ssis0010 "Link to this heading")

Multiple models write to the same destination table.

### Severity[¶](#id27 "Link to this heading")
...
### Converted Code[¶](#id29 "Link to this heading")
...
## SSC-EWI-SSIS0011[¶](#ssc-ewi-ssis0011 "Link to this heading")
...
### Converted Code[¶](#id33 "Link to this heading")
...
## SSC-EWI-SSIS0012[¶](#ssc-ewi-ssis0012 "Link to this heading")
...
### Converted Code[¶](#id37 "Link to this heading")
...
## SSC-EWI-SSIS0013[¶](#ssc-ewi-ssis0013 "Link to this heading")

Complex property expression requires manual implementation.

### Severity[¶](#id38 "Link to this heading")
...
### Converted Code[¶](#id40 "Link to this heading")
...
## SSC-EWI-SSIS0014[¶](#ssc-ewi-ssis0014 "Link to this heading")
...
### Converted Code[¶](#id43 "Link to this heading")
...
## SSC-EWI-SSIS0015[¶](#ssc-ewi-ssis0015 "Link to this heading")

Send Mail Task file attachments are not supported in Snowflake.

### Severity[¶](#id45 "Link to this heading")
...
### Converted Code[¶](#id47 "Link to this heading")
...
## SSC-EWI-SSIS0016[¶](#ssc-ewi-ssis0016 "Link to this heading")

Send Mail Task email priority is not supported in Snowflake.

### Severity[¶](#id49 "Link to this heading")
...
### Converted Code[¶](#id51 "Link to this heading")
...
## SSC-EWI-SSIS0017[¶](#ssc-ewi-ssis0017 "Link to this heading")

Send Mail Task file-based message source is not supported.

### Severity[¶](#id53 "Link to this heading")
...
### Converted Code[¶](#id55 "Link to this heading")
...
### Best Practices[¶](#id56 "Link to this heading")
...
## SSC-EWI-SSIS0018[¶](#ssc-ewi-ssis0018 "Link to this heading")

Send Mail Task HTML body format is not supported in Snowflake.

### Severity[¶](#id57 "Link to this heading")
...
### Converted Code[¶](#id59 "Link to this heading")
...
1. [SSC-EWI-SSIS0001](#ssc-ewi-ssis0001)
2. [SSC-EWI-SSIS0002](#ssc-ewi-ssis0002)
3. [SSC-EWI-SSIS0003](#ssc-ewi-ssis0003)
4. [SSC-EWI-SSIS0004](#ssc-ewi-ssis0004)
5. [SSC-EWI-SSIS0005](#ssc-ewi-ssis0005)
6. [SSC-EWI-SSIS0006](#ssc-ewi-ssis0006)
7. [SSC-EWI-SSIS0007](#ssc-ewi-ssis0007)
8. [SSC-EWI-SSIS0008](#ssc-ewi-ssis0008)
9. [SSC-EWI-SSIS0009](#ssc-ewi-ssis0009)
10. [SSC-EWI-SSIS0010](#ssc-ewi-ssis0010)
11. [SSC-EWI-SSIS0011](#ssc-ewi-ssis0011)
12. [SSC-EWI-SSIS0012](#ssc-ewi-ssis0012)
13. [SSC-EWI-SSIS0013](#ssc-ewi-ssis0013)
14. [SSC-EWI-SSIS0014](#ssc-ewi-ssis0014)
15. [SSC-EWI-SSIS0015](#ssc-ewi-ssis0015)
16. [SSC-EWI-SSIS0016](#ssc-ewi-ssis0016)
17. [SSC-EWI-SSIS0017](#ssc-ewi-ssis0017)
18. [SSC-EWI-SSIS0018](#ssc-ewi-ssis0018)