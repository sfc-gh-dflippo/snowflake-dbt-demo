...
auto_generated: true
description: Note
last_scraped: '2026-01-14T16:56:48.929002+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/technical-documentation/issues-and-troubleshooting/functional-difference/postgresqlFDM.html
title: SnowConvert AI - PostgreSQL Functional Differences | Snowflake Documentation
---
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)General[Technical Documentation](../../README.md)[Issues And Troubleshooting](../README.md)[Functional Difference](README.md)PostgreSQL

# SnowConvert AI - PostgreSQL Functional Differences[¶](#snowconvert-ai-postgresql-functional-differences "Link to this heading")
...
## SSC-FDM-PG0001[¶](#ssc-fdm-pg0001 "Link to this heading")
...
##### SQLFOUND Example[¶](#sqlfound-example "Link to this heading")
...
##### IS\_FOUND\_UDF Example[¶](#is-found-udf-example "Link to this heading")
...
##### IS\_FOUND\_UDF Source Code[¶](#is-found-udf-source-code "Link to this heading")
...
##### PostgreSQL[¶](#id5 "Link to this heading")
...
##### Select Into Statement[¶](#select-into-statement "Link to this heading")

##### PostgreSQL[¶](#id7 "Link to this heading")
...
##### Perform Statement:[¶](#perform-statement "Link to this heading")
...
##### Fetch Statement:[¶](#fetch-statement "Link to this heading")

##### PostgreSQL[¶](#id11 "Link to this heading")
...
## SSC-FDM-PG0002[¶](#ssc-fdm-pg0002 "Link to this heading")
...
#### Code Example[¶](#id14 "Link to this heading")
...
##### Explicit Cast[¶](#explicit-cast "Link to this heading")
...
##### Column Definition[¶](#id15 "Link to this heading")
...
##### Explicit Cast[¶](#id16 "Link to this heading")
...
## SSC-FDM-PG0003[¶](#ssc-fdm-pg0003 "Link to this heading")
...
#### Best Practices[¶](#id21 "Link to this heading")
...
## SSC-FDM-PG0004[¶](#ssc-fdm-pg0004 "Link to this heading")

The date output format may vary

### Description[¶](#id22 "Link to this heading")

The date output format may vary depending on the Timestamp type and the timestamp\_output\_format being used, you can consult [here](https://docs.snowflake.com/en/sql-reference/functions/current_timestamp.html).

#### Code Example[¶](#id23 "Link to this heading")

##### Input Code:[¶](#id24 "Link to this heading")

##### PostgreSQL[¶](#id25 "Link to this heading")
...
##### PostgreSQL[¶](#id29 "Link to this heading")
...
##### Generated Code:[¶](#id30 "Link to this heading")
...
##### PostgreSQL[¶](#id34 "Link to this heading")
...
##### Generated Code[¶](#id36 "Link to this heading")
...
## SSC-FDM-PG0005[¶](#ssc-fdm-pg0005 "Link to this heading")
...
#### Code Example[¶](#id40 "Link to this heading")

##### Input Code:[¶](#id41 "Link to this heading")

##### PostgreSQL[¶](#id42 "Link to this heading")
...
## SSC-FDM-PG0006[¶](#ssc-fdm-pg0006 "Link to this heading")

Set search path with multiple schemas.

### Description[¶](#id45 "Link to this heading")

Set search path with multiple schemas is not supported in Snowflake, you can consult [here](https://docs.snowflake.com/en/sql-reference/sql/use-schema.html).

#### Code Example[¶](#id46 "Link to this heading")

##### Input Code:[¶](#id47 "Link to this heading")

##### PostgreSQL[¶](#id48 "Link to this heading")
...
##### Generated Code:[¶](#id49 "Link to this heading")
...
## SSC-FDM-PG0007[¶](#ssc-fdm-pg0007 "Link to this heading")

NULL is converted to ‘’ and may have a different behavior in Snowflake.

### Severity[¶](#id51 "Link to this heading")
...
#### Code Example[¶](#id53 "Link to this heading")

##### Input Code:[¶](#id54 "Link to this heading")

##### PostgreSQL[¶](#id55 "Link to this heading")
...
## SSC-FDM-PG0008[¶](#ssc-fdm-pg0008 "Link to this heading")
...
#### Code Example[¶](#id59 "Link to this heading")

##### Input Code:[¶](#id60 "Link to this heading")

##### PostgreSQL[¶](#id61 "Link to this heading")
...
##### Generated Code:[¶](#id62 "Link to this heading")
...
## SSC-FDM-PG0009[¶](#ssc-fdm-pg0009 "Link to this heading")
...
#### Code Example[¶](#id65 "Link to this heading")

##### Input Code:[¶](#id66 "Link to this heading")

##### PostgreSQL[¶](#id67 "Link to this heading")
...
| resultShiftedLeft | resultShiftedRight |
| --- | --- |
| -2147483648 | 16 |

##### Generated Code:[¶](#id74 "Link to this heading")
...
## SSC-FDM-PG0011[¶](#ssc-fdm-pg0011 "Link to this heading")
...
##### PostgreSql[¶](#id80 "Link to this heading")
...
##### Results[¶](#id81 "Link to this heading")
...
##### Results[¶](#id83 "Link to this heading")
...
## SSC-FDM-PG0012[¶](#ssc-fdm-pg0012 "Link to this heading")
...
##### PostgreSql[¶](#id88 "Link to this heading")
...
#### Best Practices[¶](#id93 "Link to this heading")

* Review the procedure logic to ensure this variable is not assigned a `NULL` value.

## SSC-FDM-PG0013[¶](#ssc-fdm-pg0013 "Link to this heading")
...
##### PostgreSql[¶](#id97 "Link to this heading")
...
## SSC-FDM-PG0014[¶](#ssc-fdm-pg0014 "Link to this heading")
...
#### Code Example[¶](#id102 "Link to this heading")

##### Input Code:[¶](#id103 "Link to this heading")

##### PostgreSql[¶](#id104 "Link to this heading")
...
##### Generated Code:[¶](#id105 "Link to this heading")
...
## SSC-FDM-PG0015[¶](#ssc-fdm-pg0015 "Link to this heading")
...
##### Generated Code: [¶](#id110 "Link to this heading")
...
## SSC-FDM-PG0016[¶](#ssc-fdm-pg0016 "Link to this heading")
...
## SSC-FDM-PG0017[¶](#ssc-fdm-pg0017 "Link to this heading")
...
## SSC-FDM-PG0018[¶](#ssc-fdm-pg0018 "Link to this heading")
...
#### Example Code[¶](#id120 "Link to this heading")

##### Input Code: [¶](#id121 "Link to this heading")
...
##### Generated Code: [¶](#id122 "Link to this heading")
...
#### Best Practices[¶](#id123 "Link to this heading")
...
1. [SSC-FDM-PG0001](#ssc-fdm-pg0001)
2. [SSC-FDM-PG0002](#ssc-fdm-pg0002)
3. [SSC-FDM-PG0003](#ssc-fdm-pg0003)
4. [SSC-FDM-PG0004](#ssc-fdm-pg0004)
5. [SSC-FDM-PG0005](#ssc-fdm-pg0005)
6. [SSC-FDM-PG0006](#ssc-fdm-pg0006)
7. [SSC-FDM-PG0007](#ssc-fdm-pg0007)
8. [SSC-FDM-PG0008](#ssc-fdm-pg0008)
9. [SSC-FDM-PG0009](#ssc-fdm-pg0009)
10. [SSC-FDM-PG0010](#ssc-fdm-pg0010)
11. [SSC-FDM-PG0011](#ssc-fdm-pg0011)
12. [SSC-FDM-PG0012](#ssc-fdm-pg0012)
13. [SSC-FDM-PG0013](#ssc-fdm-pg0013)
14. [SSC-FDM-PG0014](#ssc-fdm-pg0014)
15. [SSC-FDM-PG0015](#ssc-fdm-pg0015)
16. [SSC-FDM-PG0016](#ssc-fdm-pg0016)
17. [SSC-FDM-PG0017](#ssc-fdm-pg0017)
18. [SSC-FDM-PG0018](#ssc-fdm-pg0018)