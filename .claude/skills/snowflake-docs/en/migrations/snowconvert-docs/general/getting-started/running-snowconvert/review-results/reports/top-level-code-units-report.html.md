---
auto_generated: true
description: A Code Unit, as the name suggests, is the most atomic, standalone executable
  element. In most cases, these are statements, but they also include script files
  as well because those are executed as a si
last_scraped: '2026-01-14T16:55:09.573898+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/getting-started/running-snowconvert/review-results/reports/top-level-code-units-report.html
title: SnowConvert AI - Top-Level Code Units Report | Snowflake Documentation
---
...
[Guides](../../../../../../../guides/README.md)[Migrations](../../../../../../README.md)Tools[SnowConvert AI](../../../../../overview.md)General[Getting Started](../../../README.md)[Running Snowconvert AI](../../README.md)[Review Results](../README.md)[Reports](README.md)Top Level Code Units Report

# SnowConvert AI - Top-Level Code Units Report[¶](#snowconvert-ai-top-level-code-units-report "Link to this heading")

## What is a Top-Level Code Unit?[¶](#what-is-a-top-level-code-unit "Link to this heading")
...
## What is an out-of-scope Code Unit?[¶](#what-is-an-out-of-scope-code-unit "Link to this heading")
...
## Examples of Top-Level Code Units[¶](#examples-of-top-level-code-units "Link to this heading")
...
### Package Bodies in Oracle[¶](#package-bodies-in-oracle "Link to this heading")
...
### Teradata Script files[¶](#teradata-script-files "Link to this heading")
...
### Transact SQL batches with GOTO[¶](#transact-sql-batches-with-goto "Link to this heading")
...
## How is the Code Unit methodology represented in other reports?[¶](#how-is-the-code-unit-methodology-represented-in-other-reports "Link to this heading")
...
### Issues Report[¶](#issues-report "Link to this heading")
...
### Object References Report and Missing Objects Report[¶](#object-references-report-and-missing-objects-report "Link to this heading")
...
## Information in the Top-Level Code Units Report[¶](#information-in-the-top-level-code-units-report "Link to this heading")
...
## Deployment Order[¶](#deployment-order "Link to this heading")
...
#### Code Units with Missing Dependencies[¶](#code-units-with-missing-dependencies "Link to this heading")
...
#### Code Units referencing Database Links (Oracle)[¶](#code-units-referencing-database-links-oracle "Link to this heading")
...
#### Code Units referencing DDLs defined inside Stored Procedures, Anonymous Blocks, etc[¶](#code-units-referencing-ddls-defined-inside-stored-procedures-anonymous-blocks-etc "Link to this heading")
...
1. [What is a Top-Level Code Unit?](#what-is-a-top-level-code-unit)
2. [What is an out-of-scope Code Unit?](#what-is-an-out-of-scope-code-unit)
3. [Examples of Top-Level Code Units](#examples-of-top-level-code-units)
4. [How is the Code Unit methodology represented in other reports?](#how-is-the-code-unit-methodology-represented-in-other-reports)
5. [Information in the Top-Level Code Units Report](#information-in-the-top-level-code-units-report)
6. [Example](#example)
