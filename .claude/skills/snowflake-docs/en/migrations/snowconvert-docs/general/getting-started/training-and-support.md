---
auto_generated: true
description: We highly recommend that you go through the SnowConvert AI training in
  order to get the most out of SnowConvert AI. This training provides participants
  with the core knowledge to recognize how SnowCon
last_scraped: '2026-01-14T16:51:17.054183+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/getting-started/training-and-support
title: SnowConvert AI - Training and Support | Snowflake Documentation
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[SnowConvert AI](../../overview.md)General[Getting Started](README.md)Training And Support

# SnowConvert AI - Training and Support[¶](#snowconvert-ai-training-and-support "Link to this heading")

## SnowConvert AI for Developers[¶](#snowconvert-ai-for-developers "Link to this heading")

We **highly** recommend that you go through the [SnowConvert AI](https://learn.snowflake.com/en/courses/OD-SC-D/) training in order to get the most out of SnowConvert AI. This training provides participants with the core knowledge to recognize how SnowConvert AI fits into the migration process and the skills to prepare, assess, and execute a code conversion with SnowConvert AI to accelerate their journey to Snowflake.
...
1. [SnowConvert AI for Developers](#snowconvert-ai-for-developers)