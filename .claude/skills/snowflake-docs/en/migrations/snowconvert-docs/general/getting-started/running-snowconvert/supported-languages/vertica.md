---
auto_generated: true
description: SnowConvert AI is a software that understands SQL Vertica scripts and
  converts this source code into functionally equivalent Snowflake code.
last_scraped: '2026-01-14T16:52:31.854376+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/getting-started/running-snowconvert/supported-languages/vertica
title: SnowConvert AI - Vertica | Snowflake Documentation
---
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)General[Getting Started](../../README.md)[Running Snowconvert AI](../README.md)[Supported Languages](README.md)Vertica

# SnowConvert AI - Vertica[¶](#snowconvert-ai-vertica "Link to this heading")

## What is SnowConvert AI for Vertica?[¶](#what-is-snowconvert-ai-for-vertica "Link to this heading")

SnowConvert AI is a software that understands SQL Vertica scripts and converts this source code into functionally equivalent Snowflake code.
...
### Vertica to Snowflake SQL[¶](#vertica-to-snowflake-sql "Link to this heading")
...
1. [What is SnowConvert AI for Vertica?](#what-is-snowconvert-ai-for-vertica)
