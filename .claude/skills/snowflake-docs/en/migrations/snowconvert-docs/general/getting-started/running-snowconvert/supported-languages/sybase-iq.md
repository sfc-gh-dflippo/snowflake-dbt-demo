---
auto_generated: true
description: SnowConvert AI is a software that understands Sybase IQ scripts and converts
  this source code into functionally equivalent Snowflake code.
last_scraped: '2026-01-14T16:52:31.149285+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/getting-started/running-snowconvert/supported-languages/sybase-iq
title: SnowConvert AI - Sybase IQ | Snowflake Documentation
---
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)General[Getting Started](../../README.md)[Running Snowconvert AI](../README.md)[Supported Languages](README.md)Sybase IQ

# SnowConvert AI - Sybase IQ[¶](#snowconvert-ai-sybase-iq "Link to this heading")

## What is SnowConvert AI for Sybase IQ?[¶](#what-is-snowconvert-ai-for-sybase-iq "Link to this heading")
...
### Sybase IQ to Snowflake SQL[¶](#sybase-iq-to-snowflake-sql "Link to this heading")
...
1. [What is SnowConvert AI for Sybase IQ?](#what-is-snowconvert-ai-for-sybase-iq)
