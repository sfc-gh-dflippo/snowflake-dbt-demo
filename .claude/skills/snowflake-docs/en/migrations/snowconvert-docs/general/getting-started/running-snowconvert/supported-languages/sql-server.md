---
auto_generated: true
description: SnowConvert AI is a software that understands SQL Server scripts and
  converts this source code into functionally equivalent Snowflake code.
last_scraped: '2026-01-14T16:52:30.807051+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/getting-started/running-snowconvert/supported-languages/sql-server
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)General[Getting Started](../../README.md)[Running Snowconvert AI](../README.md)[Supported Languages](README.md)SQL Server

# SnowConvert AI - SQL Server[¶](#snowconvert-ai-sql-server "Link to this heading")

## What is SnowConvert AI for SQL Server?[¶](#what-is-snowconvert-ai-for-sql-server "Link to this heading")
...
### SQL Server to Snowflake SQL[¶](#sql-server-to-snowflake-sql "Link to this heading")
...
### SQL Server Stored Procedures to JavaScript Embedded in Snowflake SQL [¶](#sql-server-stored-procedures-to-javascript-embedded-in-snowflake-sql "Link to this heading")
...
1. [What is SnowConvert AI for SQL Server?](#what-is-snowconvert-ai-for-sql-server)
