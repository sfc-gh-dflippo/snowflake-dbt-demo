---
auto_generated: true
description: SnowConvert AI is a software that understands PostgreSQL, Greenplum or
  Netezza scripts and converts the source code into functionally equivalent Snowflake
  code.
last_scraped: '2026-01-14T16:52:30.030930+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/getting-started/running-snowconvert/supported-languages/postgresql-and-based-languages
title: SnowConvert AI - PostgreSQL-Greenplum-Netezza | Snowflake Documentation
---
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)General[Getting Started](../../README.md)[Running Snowconvert AI](../README.md)[Supported Languages](README.md)PostgreSQL-Greenplum-Netezza

# SnowConvert AI - PostgreSQL-Greenplum-Netezza[¶](#snowconvert-ai-postgresql-greenplum-netezza "Link to this heading")

## What is SnowConvert AI for PostgreSQL-Greenplum-Netezza?[¶](#what-is-snowconvert-ai-for-postgresql-greenplum-netezza "Link to this heading")

SnowConvert AI is a software that understands PostgreSQL, Greenplum or Netezza scripts and converts the source code into functionally equivalent Snowflake code.
...
### PostgreSQL-Greenplum-Netezza to Snowflake SQL[¶](#postgresql-greenplum-netezza-to-snowflake-sql "Link to this heading")
...
1. [What is SnowConvert AI for PostgreSQL-Greenplum-Netezza?](#what-is-snowconvert-ai-for-postgresql-greenplum-netezza)
