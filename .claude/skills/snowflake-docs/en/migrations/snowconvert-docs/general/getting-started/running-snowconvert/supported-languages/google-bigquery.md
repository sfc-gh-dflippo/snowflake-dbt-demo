---
auto_generated: true
description: SnowConvert AI is a software that understands SQL Google BigQuery scripts
  and converts this source code into functionally equivalent Snowflake code.
last_scraped: '2026-01-14T16:52:28.573545+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/getting-started/running-snowconvert/supported-languages/google-bigquery
title: SnowConvert AI - Google BigQuery | Snowflake Documentation
---
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)General[Getting Started](../../README.md)[Running Snowconvert AI](../README.md)[Supported Languages](README.md)Google BigQuery

# SnowConvert AI - Google BigQuery[¶](#snowconvert-ai-google-bigquery "Link to this heading")

## What is SnowConvert AI for Google BigQuery?[¶](#what-is-snowconvert-ai-for-google-bigquery "Link to this heading")

SnowConvert AI is a software that understands SQL Google BigQuery scripts and converts this source code into functionally equivalent Snowflake code.
...
### Google BigQuery to Snowflake SQL[¶](#google-bigquery-to-snowflake-sql "Link to this heading")
...
1. [What is SnowConvert AI for Google BigQuery?](#what-is-snowconvert-ai-for-google-bigquery)
