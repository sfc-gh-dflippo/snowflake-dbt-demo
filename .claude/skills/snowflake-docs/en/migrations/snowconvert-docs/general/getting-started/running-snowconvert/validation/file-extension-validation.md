---
auto_generated: true
description: 'This validation step verifies the file extensions. These are the valid
  file extensions:'
last_scraped: '2026-01-14T16:52:33.183613+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/getting-started/running-snowconvert/validation/file-extension-validation
title: SnowConvert AI - File Extension Validation | Snowflake Documentation
---
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)General[Getting Started](../../README.md)[Running Snowconvert AI](../README.md)[Validation](README.md)File Extension Validation

# SnowConvert AI - File Extension Validation[¶](#snowconvert-ai-file-extension-validation "Link to this heading")
...
**IMPORTANT**! Capital letter file extensions are invalid too.

If one of the files has an invalid extension, a window with a warning is displayed like the next one:

![File's Extension Validation Failed](../../../../../../_images/image%2810%29.png)

Also, in the ScopeValidation report, you will find information about the failed file (s).

![ScopeValidation.csv report](../../../../../../_images/image%2811%29.png)
