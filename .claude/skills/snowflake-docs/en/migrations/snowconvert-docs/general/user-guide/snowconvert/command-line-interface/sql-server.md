---
auto_generated: true
description: Flag to indicate whether or not the Transact SQL USE statement should
  be translated.
last_scraped: '2026-01-14T16:52:57.225708+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/user-guide/snowconvert/command-line-interface/sql-server
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)GeneralUser Guide[SnowConvert AI](../README.md)[Command Line Interface](README.md)SQL Server
...
### `-u, --usedatabase`[¶](#u-usedatabase "Link to this heading")

Flag to indicate whether or not the Transact SQL USE statement should be translated.

#### `-p, --arrange <ARRANGE OPTION>` [`<ARRANGE OPTION>`][¶](#p-arrange-arrange-option-arrange-option "Link to this heading")
