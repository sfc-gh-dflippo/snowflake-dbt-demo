---
auto_generated: true
description: Now that you’ve downloaded the tool, you can run the installer. Follow
  the steps below to get started using SnowConvert.
last_scraped: '2026-01-14T16:52:54.216961+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/general/user-guide/snowconvert/how-to-install-the-tool/README
title: SnowConvert AI - How to install the tool | Snowflake Documentation
---
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)GeneralUser Guide[SnowConvert AI](../README.md)How To Install The Tool

# SnowConvert AI - How to install the tool[¶](#snowconvert-ai-how-to-install-the-tool "Link to this heading")

## Installation[¶](#installation "Link to this heading")

Now that you’ve [downloaded](../../../getting-started/download-and-access) the tool, you can run the installer. Follow the steps below to get started using SnowConvert.
