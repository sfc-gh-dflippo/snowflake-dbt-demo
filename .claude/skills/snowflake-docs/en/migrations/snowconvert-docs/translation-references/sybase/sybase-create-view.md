---
auto_generated: true
description: Creates a new view in the current database. You define a list of columns,
  which each hold data of a distinct type. The owner of the view is the issuer of
  the CREATE VIEW command.
last_scraped: '2026-01-14T16:53:56.917130+00:00'
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[SnowConvert AI](../../overview.md)Translation References[Sybase IQ](README.md)StatementsCREATE VIEW

# SnowConvert AI - Sybase IQ - CREATE VIEW[¶](#snowconvert-ai-sybase-iq-create-view "Link to this heading")
