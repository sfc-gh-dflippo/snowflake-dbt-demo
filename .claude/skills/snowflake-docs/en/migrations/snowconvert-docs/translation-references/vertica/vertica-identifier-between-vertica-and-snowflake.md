---
auto_generated: true
description: 'In Vertica, quoted identifiers sticks to the case sensitivity rules,
  which means that, for example, column names are still case insensitive even when
  quoted. Thus, identifiers "ABC", "ABc", and "aBc" '
last_scraped: '2026-01-14T16:54:12.115520+00:00'
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[SnowConvert AI](../../overview.md)Translation References[Vertica](README.md)Identifier differences between Vertica and Snowflake

# SnowConvert AI - Vertica - Identifier differences between Vertica and Snowflake[¶](#snowconvert-ai-vertica-identifier-differences-between-vertica-and-snowflake "Link to this heading")

## Quoted identifiers[¶](#quoted-identifiers "Link to this heading")

In Vertica, quoted identifiers sticks to the [case sensitivity rules](https://docs.vertica.com/25.1.x/en/sql-reference/language-elements/identifiers/#case-sensitivity), which means that, for example, column names are still case insensitive even when quoted. Thus, identifiers `"ABC"`, `"ABc"`, and `"aBc"` are synonymous, as are `ABC`, `ABc`, and `aBc` :
...
## How SnowConvert AI migrates quoted identifiers[¶](#how-snowconvert-ai-migrates-quoted-identifiers "Link to this heading")

SnowConvert AI will analyze quoted identifiers to determine if they contain non-alphanumeric characters or are reserved words in Snowflake, if they do SnowConvert AI will left them as they are, alphanumeric identifiers will be left unquoted:

### Vertica[¶](#id1 "Link to this heading")
...
1. [Quoted identifiers](#quoted-identifiers)
2. [How SnowConvert AI migrates quoted identifiers](#how-snowconvert-ai-migrates-quoted-identifiers)