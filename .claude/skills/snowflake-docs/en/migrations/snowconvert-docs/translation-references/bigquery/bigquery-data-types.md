---
auto_generated: true
description: Snowflake provides support for the majority of fundamental SQL data types,
  with specific restrictions, across various SQL constructs including columns, local
  variables, expressions, and parameters.
last_scraped: '2026-01-14T16:53:04.034459+00:00'
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[SnowConvert AI](../../overview.md)Translation References[BigQuery](README.md)Data Types

# SnowConvert AI - BigQuery - Data types[¶](#snowconvert-ai-bigquery-data-types "Link to this heading")
...
## Bytes Data Type[¶](#bytes-data-type "Link to this heading")
...
## Datetime Data Types[¶](#datetime-data-types "Link to this heading")
...
## Interval Data Type[¶](#interval-data-type "Link to this heading")
...
## String Data Types[¶](#string-data-types "Link to this heading")
...
## ANY TYPE[¶](#any-type "Link to this heading")
...
#### Type definition for UDFs[¶](#type-definition-for-udfs "Link to this heading")
...
## ARRAY<T>[¶](#array-t "Link to this heading")
...
#### ARRAY access by index[¶](#array-access-by-index "Link to this heading")

##### BigQuery[¶](#id5 "Link to this heading")
...
#### Safe ARRAY access by index[¶](#safe-array-access-by-index "Link to this heading")

##### BigQuery[¶](#id7 "Link to this heading")
...
#### INSERT with ARRAY in the VALUES clause[¶](#insert-with-array-in-the-values-clause "Link to this heading")

##### BigQuery[¶](#id9 "Link to this heading")
...
#### MERGE statement[¶](#merge-statement "Link to this heading")
...
#### ARRAY DEFAULT column value insertion/update[¶](#array-default-column-value-insertion-update "Link to this heading")
...
#### INSERT/UPDATE with NULL value[¶](#insert-update-with-null-value "Link to this heading")
...
#### ARRAY concatenation[¶](#array-concatenation "Link to this heading")

##### BigQuery[¶](#id17 "Link to this heading")
...
#### ARRAY used as parameter/return type[¶](#array-used-as-parameter-return-type "Link to this heading")
...
When non-safe access to elements in an array is detected SnowConvert AI will generate [SSC-FDM-BQ0001](../../general/technical-documentation/issues-and-troubleshooting/functional-difference/bigqueryFDM.html#ssc-fdm-bq0001) to warn the user about this.

### Related EWIs[¶](#related-ewis "Link to this heading")

1. [SSC-FDM-BQ0001](../../general/technical-documentation/issues-and-troubleshooting/functional-difference/bigqueryFDM.html#ssc-fdm-bq0001): Accessing arrays produces NULL instead of an error for positive out of bounds indexes in Snowflake.

## BYTES[¶](#bytes "Link to this heading")
...
#### BYTES output format[¶](#bytes-output-format "Link to this heading")
...
#### BYTES Literal[¶](#bytes-literal "Link to this heading")
...
## GEOGRAPHY[¶](#geography "Link to this heading")
...
#### GEOGRAPHY output format[¶](#geography-output-format "Link to this heading")
...
#### Insert GEOGRAPHY data[¶](#insert-geography-data "Link to this heading")
...
#### Observations[¶](#id29 "Link to this heading")
...
#### Interval with a single DateTime part[¶](#interval-with-a-single-datetime-part "Link to this heading")

##### BigQuery[¶](#id32 "Link to this heading")
...
#### Interval with a DateTime part range[¶](#interval-with-a-datetime-part-range "Link to this heading")

##### BigQuery[¶](#id35 "Link to this heading")
...
#### Interval as a Column data type[¶](#interval-as-a-column-data-type "Link to this heading")

##### BigQuery[¶](#id39 "Link to this heading")
...
#### Interval comparison[¶](#interval-comparison "Link to this heading")

##### BigQuery[¶](#id43 "Link to this heading")
...
##### 2. Working with signs in the Interval data type[¶](#working-with-signs-in-the-interval-data-type "Link to this heading")
...
2. [SSC-EWI-0107](../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/generalEWI.html#ssc-ewi-0107): Interval Literal Not Supported In Current Scenario.
...
#### JSON Literals[¶](#json-literals "Link to this heading")
...
#### BigQuery[¶](#id55 "Link to this heading")
...
#### Insert INT Data Type to STRUCT column[¶](#insert-int-data-type-to-struct-column "Link to this heading")

##### BigQuery[¶](#id57 "Link to this heading")
...
#### Insert STRING Data Type to STRUCT column[¶](#insert-string-data-type-to-struct-column "Link to this heading")

##### BigQuery[¶](#id59 "Link to this heading")
...
#### Insert STRUCT Data Type to STRUCT column[¶](#insert-struct-data-type-to-struct-column "Link to this heading")
...
#### Insert ARRAY Data Type to STRUCT column[¶](#insert-array-data-type-to-struct-column "Link to this heading")

##### BigQuery[¶](#id63 "Link to this heading")
...
#### Insert to selected STRUCT columns[¶](#insert-to-selected-struct-columns "Link to this heading")

##### BigQuery[¶](#id65 "Link to this heading")
...
#### Insert to STRUCT column tuple syntax[¶](#insert-to-struct-column-tuple-syntax "Link to this heading")

Warning

Translation of tuple syntax values is currently not supported.

##### BigQuery[¶](#id67 "Link to this heading")
...
#### Update STRUCT column[¶](#update-struct-column "Link to this heading")

##### BigQuery[¶](#id69 "Link to this heading")
...
#### Update STRUCT column field[¶](#update-struct-column-field "Link to this heading")

##### BigQuery[¶](#id71 "Link to this heading")
...
##### Snowflake[¶](#id72 "Link to this heading")
...
#### Select from STRUCT column[¶](#select-from-struct-column "Link to this heading")

##### BigQuery[¶](#id73 "Link to this heading")
...
#### Select from STRUCT column tuple syntax[¶](#select-from-struct-column-tuple-syntax "Link to this heading")

##### BigQuery[¶](#id75 "Link to this heading")
...
#### Create a view using an anonymous STRUCT definition[¶](#create-a-view-using-an-anonymous-struct-definition "Link to this heading")

##### BigQuery[¶](#id77 "Link to this heading")
...
#### STRUCT column comparison expressions[¶](#struct-column-comparison-expressions "Link to this heading")
...
##### BigQuery[¶](#id79 "Link to this heading")
...
1. [SSC-FDM-BQ0010](../../general/technical-documentation/issues-and-troubleshooting/functional-difference/bigqueryFDM.html#ssc-fdm-bq0010): Struct converted to VARIANT. Some of its usages might have functional differences.
2. [SSC-EWI-BQ0012](../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/bigqueryEWI.html#ssc-ewi-bq0012): Unable to generate correct OBJECT\_CONSTRUCT parameter.
3. [SSC-FDM-BQ0008](../../general/technical-documentation/issues-and-troubleshooting/functional-difference/bigqueryFDM.html#ssc-fdm-bq0008): Where clause references a column of STRUCT type.
...
#### TIMESTAMP without time[¶](#timestamp-without-time "Link to this heading")

##### BigQuery[¶](#id84 "Link to this heading")
...
#### TIMESTAMP with time zone[¶](#timestamp-with-time-zone "Link to this heading")
...
##### BigQuery[¶](#id88 "Link to this heading")
...
1. [Boolean Data Type](#boolean-data-type)
2. [Bytes Data Type](#bytes-data-type)
3. [Datetime Data Types](#datetime-data-types)
4. [Geography Data Type](#geography-data-type)
5. [Interval Data Type](#interval-data-type)
6. [Json Data Type](#json-data-type)
7. [Numeric Data Types](#numeric-data-types)
8. [String Data Types](#string-data-types)
9. [ANY TYPE](#any-type)
10. [ARRAY<T>](#array-t)
11. [BYTES](#bytes)
