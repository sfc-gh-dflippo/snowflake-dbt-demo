---
auto_generated: true
description: In this section you could find information about general statements of
  Transact-SQL.
last_scraped: '2026-01-14T16:54:08.793472+00:00'
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[SnowConvert AI](../../overview.md)Translation References[SQL Server-Azure Synapse](README.md)General Statements

# SnowConvert AI - SQL Server-Azure Synapse - General Language Elements[¶](#snowconvert-ai-sql-server-azure-synapse-general-language-elements "Link to this heading")
...
1. [SSC-EWI-TS0077](../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/sqlServerEWI.html#ssc-ewi-ts0077): This message is shown when there is a collate clause that is not supported in Snowflake.
2. [SSC-FDM-TS0002](../../general/technical-documentation/issues-and-troubleshooting/functional-difference/sqlServerFDM.html#ssc-fdm-ts0002): This message is shown when there is a collate clause that is not supported in Snowflake.
3. [SSC-PRF-0002](../../general/technical-documentation/issues-and-troubleshooting/performance-review/generalPRF.html#ssc-prf-0002): Case-insensitive columns can decrease the performance of queries.

## COMPUTED COLUMN[¶](#computed-column "Link to this heading")
...
1. [SSC-FDM-TS0014](../../general/technical-documentation/issues-and-troubleshooting/functional-difference/sqlServerFDM.html#ssc-fdm-ts0014): Computed column transformed.

## OUTER APPLY[¶](#outer-apply "Link to this heading")
...
### Snowflake equivalence[¶](#snowflake-equivalence "Link to this heading")
...
##### Translation output[¶](#translation-output "Link to this heading")
...
##### Translation output[¶](#id8 "Link to this heading")
...
### Translation Examples[¶](#translation-examples "Link to this heading")

#### Source[¶](#id10 "Link to this heading")
...
#### Output[¶](#id11 "Link to this heading")
...
#### Database name[¶](#database-name "Link to this heading")
...
#### User Defined Database[¶](#user-defined-database "Link to this heading")
...
For more information about Execute visit: [Execute inside Procedures](transact-create-procedure.html#exec-execute)
...
### Input[¶](#id19 "Link to this heading")
...
### Output (Inside SnowScript)[¶](#output-inside-snowscript "Link to this heading")
...
### Output (Outside of SnowScript)[¶](#output-outside-of-snowscript "Link to this heading")
...
## System Stored Procedures[¶](#system-stored-procedures "Link to this heading")

## SP\_EXECUTESQL[¶](#sp-executesql "Link to this heading")
...
check [TRANSFORM\_SP\_EXECUTE\_SQL\_STRING\_UDF(STRING, STRING, ARRAY, ARRAY)](../../general/technical-documentation/function-references/sql-server/README.html#transform-sp-execute-sql-string-udf-string-string-array-array).
...
#### Without embedded parameters[¶](#without-embedded-parameters "Link to this heading")
...
##### Transact[¶](#id24 "Link to this heading")
...
##### Results[¶](#id26 "Link to this heading")
...
#### With embedded parameters for data binding[¶](#with-embedded-parameters-for-data-binding "Link to this heading")
...
##### Transact[¶](#id27 "Link to this heading")
...
##### Results[¶](#id30 "Link to this heading")

| Name | ID | AGE |
| --- | --- | --- |
| John Doe | 2 | 21 |

#### With embedded OUTPUT parameters[¶](#with-embedded-output-parameters "Link to this heading")
...
##### Transact[¶](#id31 "Link to this heading")
...
#### With both embedded OUTPUT parameters and data binding[¶](#with-both-embedded-output-parameters-and-data-binding "Link to this heading")

The translation is the same as for only OUTPUT parameters.

##### Transact[¶](#id35 "Link to this heading")
...
##### Results[¶](#id36 "Link to this heading")
...
#### Parameters not in order of definition[¶](#parameters-not-in-order-of-definition "Link to this heading")
...
##### Transact[¶](#id39 "Link to this heading")
...
##### Results[¶](#id42 "Link to this heading")
...
#### SQL string dynamically built[¶](#sql-string-dynamically-built "Link to this heading")
...
##### Transact[¶](#id47 "Link to this heading")
...
#### Returning multiple result sets[¶](#returning-multiple-result-sets "Link to this heading")

Snowflake Scripting procedures only allow one result set to be returned per procedure.

To replicate Transact-SQL behavior, when two or more result sets are to be returned, they are stored in temporary tables. The Snowflake Scripting procedure will return an array containing the names of the temporary tables. For more information, check [SSC-FDM-0020](../../general/technical-documentation/issues-and-troubleshooting/functional-difference/generalFDM.html#ssc-fdm-0020).

##### Transact[¶](#id51 "Link to this heading")
...
#### 1. Invalid code is detected[¶](#invalid-code-is-detected "Link to this heading")
...
For more information, check [SSC-EWI-0030](../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/generalEWI.html#ssc-ewi-0030).
...
##### Transact[¶](#id56 "Link to this heading")
...
#### 2. Valid or Invalid code is not detected[¶](#valid-or-invalid-code-is-not-detected "Link to this heading")
...
##### Transact[¶](#id60 "Link to this heading")
...
##### Results[¶](#id61 "Link to this heading")
...
#### 3. Invalid code is mistaken as valid[¶](#invalid-code-is-mistaken-as-valid "Link to this heading")
...
##### Transact[¶](#id64 "Link to this heading")
...
##### Results[¶](#id65 "Link to this heading")
...
2. [SSC-FDM-TS0028](../../general/technical-documentation/issues-and-troubleshooting/functional-difference/sqlServerFDM.html#ssc-fdm-ts0028): Output parameters must have the same order as they appear in the executed code.
3. [SSC-FDM-0020](../../general/technical-documentation/issues-and-troubleshooting/functional-difference/generalFDM.html#ssc-fdm-0020): Multiple result sets are returned in temporary tables.

## SP\_RENAME[¶](#sp-rename "Link to this heading")
...
### Translation Examples for Tables[¶](#translation-examples-for-tables "Link to this heading")

#### Source[¶](#id69 "Link to this heading")
...
#### Output[¶](#id70 "Link to this heading")
...
##### Source[¶](#id71 "Link to this heading")
...
##### Output[¶](#id72 "Link to this heading")
...
#### Translation Examples for Columns[¶](#translation-examples-for-columns "Link to this heading")

##### Source[¶](#id73 "Link to this heading")
...
##### Output[¶](#id74 "Link to this heading")
...
##### Source[¶](#id75 "Link to this heading")
...
1. [SSC-EWI-TS0075](../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/sqlServerEWI.html#ssc-ewi-ts0075): Translation for Built-In Procedure Is Not Currently Supported.
...
1. [COLLATE](#collate)
2. [COMPUTED COLUMN](#computed-column)
3. [OUTER APPLY](#outer-apply)
4. [USE](#use)
5. [EXECUTE](#execute)
6. [PRINT](#print)
7. [System Stored Procedures](#system-stored-procedures)
8. [SP\_EXECUTESQL](#sp-executesql)
9. [SP\_RENAME](#sp-rename)