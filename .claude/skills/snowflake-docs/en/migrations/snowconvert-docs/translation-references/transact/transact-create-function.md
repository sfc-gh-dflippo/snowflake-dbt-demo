...
last_scraped: '2026-01-14T16:54:03.483780+00:00'
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[SnowConvert AI](../../overview.md)Translation References[SQL Server-Azure Synapse](README.md)Data Definition LanguageCREATE FUNCTION

# SnowConvert AI - SQL Server - CREATE FUNCTION[¶](#snowconvert-ai-sql-server-create-function "Link to this heading")
...
SnowConvert supports translating SQL Server Scalar User Defined Functions directly to [Snowflake Scripting UDFs](../../../../developer-guide/udf/sql/udf-sql-procedural-functions) when they meet specific criteria.  
...
## INLINE TABLE-VALUED[¶](#inline-table-valued "Link to this heading")
...
#### Transact Syntax[¶](#transact-syntax "Link to this heading")
...
#### Snowflake SQL Syntax[¶](#snowflake-sql-syntax "Link to this heading")
...
#### Select and return values directly from one table[¶](#select-and-return-values-directly-from-one-table "Link to this heading")
...
##### Inline Table-Valued[¶](#id2 "Link to this heading")
...
##### Inline Table-Valued[¶](#id3 "Link to this heading")
...
##### Result[¶](#id4 "Link to this heading")
...
#### Select and return values from multiple tables renaming columns and using built in functions[¶](#select-and-return-values-from-multiple-tables-renaming-columns-and-using-built-in-functions "Link to this heading")
...
##### Inline Table-Valued[¶](#id6 "Link to this heading")
...
##### Snowflake SQL[¶](#id8 "Link to this heading")

##### Inline Table-Valued[¶](#id9 "Link to this heading")
...
#### Select columns using WITH statement[¶](#select-columns-using-with-statement "Link to this heading")
...
##### Inline Table-Valued[¶](#id12 "Link to this heading")
...
##### Inline Table-Valued[¶](#id15 "Link to this heading")
...
1. [SSC-FDM-TS0012](../../general/technical-documentation/issues-and-troubleshooting/functional-difference/sqlServerFDM.html#ssc-fdm-ts0012): Information for the expression was not found. CAST to STRING used
...
## MULTI-STATEMENT TABLE-VALUED[¶](#multi-statement-table-valued "Link to this heading")
...
#### **Insert values in a table**[¶](#insert-values-in-a-table "Link to this heading")

Inserts one or more rows into the table and returns the table with the new values

##### Transact-SQL[¶](#id20 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id21 "Link to this heading")
...
##### MULTI-STATEMENT TABLE-VALUED[¶](#id24 "Link to this heading")
...
#### Insert value according to if/else statement[¶](#insert-value-according-to-if-else-statement "Link to this heading")
...
##### MULTI-STATEMENT TABLE-VALUED[¶](#id26 "Link to this heading")
...
##### Snowflake SQL[¶](#id28 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id29 "Link to this heading")
...
#### Inserts multiple according to if/else statement[¶](#inserts-multiple-according-to-if-else-statement "Link to this heading")
...
##### MULTI-STATEMENT TABLE-VALUED[¶](#id32 "Link to this heading")
...
| ID\_EMPLOYEE | WORKING\_FROM\_HOME | TEAM | COMPUTER |
| --- | --- | --- | --- |
| 123456789 | 1 | TEAM\_1 | LAPTOP |

##### Snowflake[¶](#snowflake "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id34 "Link to this heading")
...
#### Update values previously inserted[¶](#update-values-previously-inserted "Link to this heading")

Updates columns values of the table into the function body and returns it with the new values.

##### Transact-SQL[¶](#id36 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id37 "Link to this heading")
...
| DEPARTMENT\_NAME | FIRST\_NAME | LAST\_NAME | START\_DATE | END\_DATE | JOB\_TITLE | MONTHS\_WORKING |
| --- | --- | --- | --- | --- | --- | --- |
...
##### Snowflake SQL[¶](#id39 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id40 "Link to this heading")
...
#### Multiple return clauses[¶](#multiple-return-clauses "Link to this heading")
...
##### Transact-SQL[¶](#id42 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id43 "Link to this heading")
...
##### Snowflake SQL[¶](#id45 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id46 "Link to this heading")
...
#### Complex cases[¶](#complex-cases "Link to this heading")

The example is a complex case that uses nested `if` statements and inserts a value depending on the true condition.

##### Transact-SQL[¶](#id48 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id49 "Link to this heading")
...
##### Snowflake SQL[¶](#id51 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id52 "Link to this heading")
...
##### Second Tab[¶](#second-tab "Link to this heading")

| VACATION\_STATUS |
| --- |
| OK |

### Known Issues[¶](#id53 "Link to this heading")

#### While statements along side queries[¶](#while-statements-along-side-queries "Link to this heading")
...
##### Transact-SQL[¶](#id54 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id55 "Link to this heading")
...
##### Snowflake SQL[¶](#id57 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id58 "Link to this heading")
...
##### Transact-SQL[¶](#id60 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id61 "Link to this heading")
...
##### Snowflake SQL[¶](#id63 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id64 "Link to this heading")
...
#### Different statements are not supported in Common Tables Expressions[¶](#different-statements-are-not-supported-in-common-tables-expressions "Link to this heading")
...
##### Transact-SQL[¶](#id66 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id67 "Link to this heading")
...
| PRODUCT\_NAME | Rating |
| --- | --- |
| HL Mountain Pedal | 3 |
| Mountain Bike Socks, M | 5 |
| Road-550-W Yellow, 40 | 5 |

##### Snowflake SQL[¶](#id69 "Link to this heading")

##### MULTI-STATEMENT TABLE-VALUED[¶](#id70 "Link to this heading")
...
#### Transact-SQL Syntax[¶](#id74 "Link to this heading")
...
#### Set and Declare Statements[¶](#set-and-declare-statements "Link to this heading")
...
##### Transact-SQL[¶](#id76 "Link to this heading")
...
#### If/Else Statement Transformation[¶](#if-else-statement-transformation "Link to this heading")
...
##### Transact-SQL[¶](#id81 "Link to this heading")
...
##### Query[¶](#id85 "Link to this heading")
...
#### Nested Statements[¶](#nested-statements "Link to this heading")
...
##### Structured Programming[¶](#structured-programming "Link to this heading")
...
#### Conditional variables through SELECTs[¶](#conditional-variables-through-selects "Link to this heading")
...
This is all aggravated by nesting and complex querying that can be found on input code. That’s why a specific [EWI](../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/generalEWI.html#ssc-ewi-0068) is added when these patterns are found.
...
##### Query[¶](#id92 "Link to this heading")
...
#### Assign and return a variable[¶](#assign-and-return-a-variable "Link to this heading")

In this simple pattern, there is a variable declaration, then, that variable is set using a `SELECT` statement and finally returned. This is going to be migrated to a [Common Table Expression](https://docs.snowflake.com/en/sql-reference/constructs/with.html) in order to keep the original behavior.

##### SQL Server[¶](#id94 "Link to this heading")

##### Query[¶](#id95 "Link to this heading")
...
##### Query[¶](#id98 "Link to this heading")
...
##### Result[¶](#id99 "Link to this heading")

| RESULT |
| --- |
| 1583978.2263 |

#### Multiple Function Calls[¶](#multiple-function-calls "Link to this heading")
...
##### SQL Server[¶](#id100 "Link to this heading")

##### Query[¶](#id101 "Link to this heading")
...
##### Query[¶](#id104 "Link to this heading")
...
#### Increase a variable based on multiple IF conditions and return its value[¶](#increase-a-variable-based-on-multiple-if-conditions-and-return-its-value "Link to this heading")
...
##### SQL Server[¶](#id106 "Link to this heading")

##### Query[¶](#id107 "Link to this heading")
...
#### Two or more RETURN statements[¶](#two-or-more-return-statements "Link to this heading")
...
##### SQL Server[¶](#id112 "Link to this heading")

##### Query[¶](#id113 "Link to this heading")
...
##### Result[¶](#id114 "Link to this heading")

| result |
| --- |
| 1 |

##### Snowflake[¶](#id115 "Link to this heading")

##### Query[¶](#id116 "Link to this heading")
...
##### Result[¶](#id117 "Link to this heading")

| RESULT |
| --- |
| 1 |

#### Common Table Expressions[¶](#common-table-expressions "Link to this heading")
...
##### SQL Server[¶](#id118 "Link to this heading")
...
##### Result[¶](#id120 "Link to this heading")
...
##### Query[¶](#id122 "Link to this heading")
...
##### Result[¶](#id123 "Link to this heading")

| RESULT |
| --- |
| 3689 |

#### Transform to JavaScript UDFs[¶](#transform-to-javascript-udfs "Link to this heading")
...
##### SQL Server[¶](#id124 "Link to this heading")
...
##### Query 1[¶](#id126 "Link to this heading")
...
##### Query 2[¶](#id127 "Link to this heading")
...
##### Result 1[¶](#id128 "Link to this heading")

| DATE |
| --- |
| 2021.0 |

##### Result 2[¶](#id129 "Link to this heading")
...
User-defined functions that use [@@ROWCOUNT](https://docs.microsoft.com/en-us/sql/t-sql/functions/rowcount-transact-sql?view=sql-server-ver15) are not supported in SQL and should be transformed to stored procedures in order to keep the functional equivalence.

Warning

User-defined functions that have `SELECT` statements assigning a variable to itself is not supported in Snowflake. See also [SELECT @local\_variable](https://docs.microsoft.com/en-us/sql/t-sql/language-elements/select-local-variable-transact-sql?view=sql-server-ver15)
...
#### Conditionals other than if/else statements along side queries[¶](#conditionals-other-than-if-else-statements-along-side-queries "Link to this heading")
...
##### Query[¶](#id134 "Link to this heading")
...
#### Assign a variable using its own value iterating through a rowset[¶](#assign-a-variable-using-its-own-value-iterating-through-a-rowset "Link to this heading")
...
3. Use- defined functions used in [COMPUTED COLUMNS](https://docs.microsoft.com/en-us/sql/relational-databases/tables/specify-computed-columns-in-a-table?view=sql-server-ver15) will fail during the execution.
...
Translation reference for SQL Server Scalar User Defined Functions to [Snowflake Scripting UDFs](../../../../developer-guide/udf/sql/udf-sql-procedural-functions)
...
##### Result[¶](#id143 "Link to this heading")

| PROFIT |
| --- |
| 50.00 |

#### Function with Conditional Logic (IF/ELSE)[¶](#function-with-conditional-logic-if-else "Link to this heading")

Functions using IF/ELSE statements for business logic.

##### SQL Server[¶](#id144 "Link to this heading")
...
##### Result[¶](#id145 "Link to this heading")

| DiscountRate |
| --- |
| 0.20 |

##### Snowflake (SnowScript UDF)[¶](#id146 "Link to this heading")
...
##### Result[¶](#id147 "Link to this heading")

| DISCOUNTRATE |
| --- |
| 0.20 |

#### Function with WHILE Loop[¶](#function-with-while-loop "Link to this heading")

Functions using WHILE loops for iterative calculations.

##### SQL Server[¶](#id148 "Link to this heading")
...
##### Result[¶](#id149 "Link to this heading")

| FactorialResult |
| --- |
| 120 |

##### Snowflake (SnowScript UDF)[¶](#id150 "Link to this heading")
...
##### Result[¶](#id151 "Link to this heading")

| FACTORIALRESULT |
| --- |
| 120 |

#### String Manipulation Function[¶](#string-manipulation-function "Link to this heading")

Complex string operations using loops and conditional logic.

##### SQL Server[¶](#id152 "Link to this heading")
...
##### Result[¶](#id153 "Link to this heading")

| CleanPhone |
| --- |
| 5551234567 |

##### Snowflake (SnowScript UDF)[¶](#id154 "Link to this heading")
...
#### CASE Statement Logic[¶](#case-statement-logic "Link to this heading")

Functions using CASE expressions for categorization.

##### SQL Server[¶](#id156 "Link to this heading")
...
##### Result[¶](#id157 "Link to this heading")

| Grade |
| --- |
| B |

##### Snowflake (SnowScript UDF)[¶](#id158 "Link to this heading")
...
##### Result[¶](#id159 "Link to this heading")
...
##### SQL Server[¶](#id160 "Link to this heading")
...
##### Snowflake (SnowScript UDF)[¶](#id162 "Link to this heading")
...
### Known Issues[¶](#id164 "Link to this heading")
...
### Related EWIs[¶](#id165 "Link to this heading")
...
3. [INLINE TABLE-VALUED](#inline-table-valued)
4. [MULTI-STATEMENT TABLE-VALUED](#multi-statement-table-valued)
5. [SCALAR](#scalar)
6. [Snowflake Script UDF (SCALAR)](#snowflake-script-udf-scalar)