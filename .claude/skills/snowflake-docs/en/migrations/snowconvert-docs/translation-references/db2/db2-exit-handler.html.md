---
auto_generated: true
description: An EXIT handler terminates the current compound statement when the specified
  condition occurs. When a condition occurs and an exit handler is invoked, control
  is passed to the handler. When the handle
last_scraped: '2026-01-14T16:55:24.224174+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/translation-references/db2/db2-exit-handler.html
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[SnowConvert AI](../../overview.md)Translation References[IBM DB2](README.md)EXIT HANDLER

# SnowConvert AI - IBM DB2 - EXIT HANDLER[¶](#snowconvert-ai-ibm-db2-exit-handler "Link to this heading")
...
### DECLARE EXIT HANDLER FOR SQLEXCEPTION[¶](#declare-exit-handler-for-sqlexception "Link to this heading")
...
### DECLARE EXIT HANDLER FOR SQLSTATE[¶](#declare-exit-handler-for-sqlstate "Link to this heading")
...
### DECLARE EXIT HANDLER FOR NOT FOUND[¶](#declare-exit-handler-for-not-found "Link to this heading")
...
See the [CONTINUE HANDLER documentation](db2-continue-handler.html#mixed-continue-and-exit-handlers) for detailed examples of this limitation.

#### Input Code:[¶](#id15 "Link to this heading")

##### IBM DB2[¶](#id16 "Link to this heading")
