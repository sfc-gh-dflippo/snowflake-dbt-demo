---
auto_generated: true
description: The Any types provide highly flexible modeling of procedure parameters
  and table columns where the actual type is not known. These data types let you dynamically
  encapsulate and access type descriptio
last_scraped: '2026-01-14T16:56:20.774144+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/translation-references/oracle/basic-elements-of-oracle-sql/data-types/any-types.html
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)Translation References[Oracle](../../README.md)Basic Elements of Oracle SQL[Data Types](README.md)Any types

# SnowConvert AI - Oracle - Any Types[¶](#snowconvert-ai-oracle-any-types "Link to this heading")
...
## ANYDATA[¶](#anydata "Link to this heading")
...
#### Create Table with ANYDATA[¶](#create-table-with-anydata "Link to this heading")
...
#### Inserting data into ANYDATA column[¶](#inserting-data-into-anydata-column "Link to this heading")
...
#### 1. No access to the ANYDATA built-in package[¶](#no-access-to-the-anydata-built-in-package "Link to this heading")
...
## ANYDATASET[¶](#anydataset "Link to this heading")
...
#### Create Table with ANYDATASET[¶](#create-table-with-anydataset "Link to this heading")
...
#### Inserting data into ANYDATASET column[¶](#inserting-data-into-anydataset-column "Link to this heading")
...
#### 1. Inserts are being parsed incorrectly[¶](#inserts-are-being-parsed-incorrectly "Link to this heading")

Some of the functions needed to create and insert a new `ANYDATASET` object are not being parsed correctly by SnowConvert.

##### 1. No access to the ANYDATASET built-in package[¶](#no-access-to-the-anydataset-built-in-package "Link to this heading")
...
3. [SSC-EWI-0028](../../../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/generalEWI.html#ssc-ewi-0028): Type not supported by Snowflake.

## ANYTYPE[¶](#anytype "Link to this heading")
...
#### Create Table with ANYTYPE[¶](#create-table-with-anytype "Link to this heading")
...
#### Inserting data into ANYTYPE column[¶](#inserting-data-into-anytype-column "Link to this heading")
...
#### 1. No access to the ANYTYPE built-in package[¶](#no-access-to-the-anytype-built-in-package "Link to this heading")
...
2. [SSC-EWI-0073](../../../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/generalEWI.html#ssc-ewi-0073): Pending Functional Equivalence Review.
3. [SSC-EWI-0028](../../../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/generalEWI.html#ssc-ewi-0028): Type not supported in Snowflake.
