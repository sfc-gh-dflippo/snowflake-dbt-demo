...
auto_generated: true
description: Danger
last_scraped: '2026-01-14T16:53:25.060957+00:00'
...
[Guides](../../../../../guides/README.md)[Migrations](../../../../README.md)Tools[SnowConvert AI](../../../overview.md)Translation References[Oracle](../README.md)[PL/SQL to Snowflake Scripting](README.md)CURSOR

# SnowConvert AI - Oracle - CURSOR[¶](#snowconvert-ai-oracle-cursor "Link to this heading")
...
Cursors are pointers that allow users to iterate through query results. For more information on Oracle Cursors check [here](https://docs.oracle.com/en/database/oracle/oracle-database/21/lnpls/static-sql.html#GUID-F1FE15F9-5C96-4C4E-B240-B7363D25A8F1).

### Oracle Cursor Syntax[¶](#oracle-cursor-syntax "Link to this heading")
...
Snowflake Scripting has support for cursors, however, they have fewer functionalities compared to Oracle. To check more information regarding these cursors, check [here](https://docs.snowflake.com/en/developer-guide/snowflake-scripting/cursors.html).

#### Snowflake Scripting Cursor Syntax[¶](#snowflake-scripting-cursor-syntax "Link to this heading")
...
### 1. Basic cursor example[¶](#basic-cursor-example "Link to this heading")

#### Oracle Cursor Example[¶](#oracle-cursor-example "Link to this heading")
...
##### Snowflake Scripting Cursor Example[¶](#snowflake-scripting-cursor-example "Link to this heading")
...
### 2. Explicit Cursor For Loop[¶](#explicit-cursor-for-loop "Link to this heading")

#### Oracle Explicit Cursor For Loop Example[¶](#oracle-explicit-cursor-for-loop-example "Link to this heading")
...
##### Snowflake Scripting Explicit Cursor For Loop Example[¶](#snowflake-scripting-explicit-cursor-for-loop-example "Link to this heading")
...
### 3. Implicit Cursor For Loop[¶](#implicit-cursor-for-loop "Link to this heading")

#### Oracle Implicit Cursor For Loop Example[¶](#oracle-implicit-cursor-for-loop-example "Link to this heading")
...
##### Snowflake Scripting Implicit Cursor For Loop Example[¶](#snowflake-scripting-implicit-cursor-for-loop-example "Link to this heading")
...
### 4. Parameterized Cursor[¶](#parameterized-cursor "Link to this heading")

You can use “?” In the filter condition of the cursor at the declaration section define the bind variable. While opening the cursor we can add the additional syntax “USING <bind\_variable\_1 >” to pass the bind variable.

Below are some examples of scenarios that can occur in the use of parameters in cursors:

#### 4.1 Basic Cursor Parameterized Example[¶](#basic-cursor-parameterized-example "Link to this heading")

##### Oracle Parameterized Cursor Example[¶](#oracle-parameterized-cursor-example "Link to this heading")
...
##### Snowflake Parameterized Cursor Example[¶](#snowflake-parameterized-cursor-example "Link to this heading")
...
#### 4.2 Parameterized Cursors With Multiple Sending Parameters[¶](#parameterized-cursors-with-multiple-sending-parameters "Link to this heading")

##### Oracle Parameterized Cursor Example[¶](#id1 "Link to this heading")
...
##### Snowflake Parameterized Cursor Example[¶](#id2 "Link to this heading")
...
#### 4.3 Parameterized Cursors With Use Of Procedure Parameters In Query[¶](#parameterized-cursors-with-use-of-procedure-parameters-in-query "Link to this heading")

##### Oracle Parameterized Cursor Example[¶](#id3 "Link to this heading")
...
##### Snowflake Parameterized Cursor Example[¶](#id4 "Link to this heading")
...
### 5. Using Cursors In Fetch And For Loop[¶](#using-cursors-in-fetch-and-for-loop "Link to this heading")
...
#### 5.1 Cursors For Loop[¶](#cursors-for-loop "Link to this heading")

##### Oracle Cursor For Loop Example[¶](#oracle-cursor-for-loop-example "Link to this heading")
...
##### Snowflake Cursor For Loop Example[¶](#snowflake-cursor-for-loop-example "Link to this heading")
...
#### 5.2 Cursors Fetch[¶](#cursors-fetch "Link to this heading")

##### Oracle Cursor Fetch Example[¶](#oracle-cursor-fetch-example "Link to this heading")
...
##### Snowflake Cursor Fetch Example[¶](#snowflake-cursor-fetch-example "Link to this heading")
...
### 1. RETURN clause is not supported in Snowflake Scripting Cursor Declaration[¶](#return-clause-is-not-supported-in-snowflake-scripting-cursor-declaration "Link to this heading")
...
#### 2. OPEN statement cannot pass values for declared arguments[¶](#open-statement-cannot-pass-values-for-declared-arguments "Link to this heading")
...
#### 3. FETCH statement cannot use records[¶](#fetch-statement-cannot-use-records "Link to this heading")

Snowflake Scripting does not support records. However, it is possible to migrate them using the OBJECT data type and the OBJECT\_CONSTRUCT() method. For more information please see the [Record Type Definition Section](collections-and-records.html#record-type-definition).

#### 4. FETCH BULK COLLECT INTO clause is not supported in Snowflake Scripting[¶](#fetch-bulk-collect-into-clause-is-not-supported-in-snowflake-scripting "Link to this heading")

Snowflake Scripting does not support the BULK COLLECT INTO clause. However, it is possible to use ARRAY\_AGG along with a temporal table to construct a new variable with the data corresponding to the Cursor information. For more information please see the [Collection Bulk Operations Section](collections-and-records.html#collection-bulk-operations).

#### 5. Cursor attributes do not exist in Snowflake Scripting[¶](#cursor-attributes-do-not-exist-in-snowflake-scripting "Link to this heading")
...
#### 6. The cursor’s query does not have access to the procedure’s variables and parameters[¶](#the-cursor-s-query-does-not-have-access-to-the-procedure-s-variables-and-parameters "Link to this heading")
...
#### 7. %NOTFOUND attribute is not supported in Snowflake Scripting Cursor[¶](#notfound-attribute-is-not-supported-in-snowflake-scripting-cursor "Link to this heading")

In Oracle can be used, before the first fetch from an open cursor, cursor\_name%NOTFOUND returns TRUE if the last fetch failed to return a row, or FALSE if the last fetch returned a row. Snowflake Scripting does not support the use of this attribute instead it can be validated if the variable assigned to the cursor result contains values
...
2. [SSC-EWI-OR0002](../../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/oracleEWI.html#ssc-ewi-or0002): Columns from expression not found.
...
#### CURSOR DECLARATION[¶](#id7 "Link to this heading")
...
## Cursor Variables[¶](#cursor-variables "Link to this heading")
...
#### 1. OPEN FOR statement with dynamic SQL inside a VARCHAR variable[¶](#open-for-statement-with-dynamic-sql-inside-a-varchar-variable "Link to this heading")

##### Oracle Example[¶](#oracle-example "Link to this heading")
...
##### Snowflake Scripting Exaple[¶](#snowflake-scripting-exaple "Link to this heading")
...
#### 2. OPEN FOR statement with dynamic SQL inside a string literal.[¶](#open-for-statement-with-dynamic-sql-inside-a-string-literal "Link to this heading")

##### Oracle Example[¶](#id12 "Link to this heading")
...
#### 3. OPEN FOR statement with SELECT statement[¶](#open-for-statement-with-select-statement "Link to this heading")

##### Oracle Example[¶](#id13 "Link to this heading")
...
##### Snowflake Scripting Example[¶](#id14 "Link to this heading")
...
#### 4. Cursor Variable declared with REF CURSOR type[¶](#cursor-variable-declared-with-ref-cursor-type "Link to this heading")

##### Oracle Example[¶](#id15 "Link to this heading")
...
##### Snowflake Scripting Example[¶](#id16 "Link to this heading")
...
#### 5. OPEN FOR statement with USING clause[¶](#open-for-statement-with-using-clause "Link to this heading")

##### Oracle Example[¶](#id17 "Link to this heading")
...
##### Snowflake Scripting Example[¶](#id18 "Link to this heading")
...
### Known Issues[¶](#id19 "Link to this heading")
...
## PARAMETRIZED CURSOR[¶](#parametrized-cursor "Link to this heading")
...
1. [SSC-PRF-0004](../../../general/technical-documentation/issues-and-troubleshooting/performance-review/generalPRF.html#ssc-prf-0004): This statement has usages of cursor for loop.

## Workaround for cursors using parameters or procedure variables[¶](#workaround-for-cursors-using-parameters-or-procedure-variables "Link to this heading")
...
#### Cursor with local variables[¶](#cursor-with-local-variables "Link to this heading")
...
##### Oracle Cursor[¶](#oracle-cursor "Link to this heading")
...
##### Snowflake Scripting Cursor[¶](#snowflake-scripting-cursor "Link to this heading")
...
#### Cursor with parameters[¶](#cursor-with-parameters "Link to this heading")
...
##### Oracle Cursor[¶](#id26 "Link to this heading")
...
##### Snowflake Scripting Cursor[¶](#id27 "Link to this heading")
...
5. [CURSOR DECLARATION](#cursor-declaration)
6. [Cursor Variables](#cursor-variables)
7. [PARAMETRIZED CURSOR](#parametrized-cursor)
8. [Workaround for cursors using parameters or procedure variables](#workaround-for-cursors-using-parameters-or-procedure-variables)