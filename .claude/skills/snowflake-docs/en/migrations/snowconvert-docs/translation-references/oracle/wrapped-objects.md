---
auto_generated: true
description: Input code can contain wrapped objects depending of the extraction tool
  used to produce it. Encrypted code will be exported as a “nonsense” group of characters
  which are preceded with the “wrapped” wo
last_scraped: '2026-01-14T16:53:30.351333+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/translation-references/oracle/wrapped-objects
title: SnowConvert AI - Oracle - Wrapped objects | Snowflake Documentation
---
...
[Guides](../../../../guides/README.md)[Migrations](../../../README.md)Tools[SnowConvert AI](../../overview.md)Translation References[Oracle](README.md)Wrapped Objects

# SnowConvert AI - Oracle - Wrapped objects[¶](#snowconvert-ai-oracle-wrapped-objects "Link to this heading")
