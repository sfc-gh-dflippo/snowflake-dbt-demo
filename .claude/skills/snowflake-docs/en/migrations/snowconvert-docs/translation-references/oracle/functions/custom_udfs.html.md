---
auto_generated: true
description: Some Oracle built-in functions and functionalities may not be available
  or may behave differently in Snowflake. To minimize these differences, some functions
  are replaced with SnowConvert AI Custom UD
last_scraped: '2026-01-14T16:56:23.253681+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/translation-references/oracle/functions/custom_udfs.html
...
[Guides](../../../../../guides/README.md)[Migrations](../../../../README.md)Tools[SnowConvert AI](../../../overview.md)Translation References[Oracle](../README.md)[Built-in Functions](README.md)Custom UDFs

# SnowConvert AI - Oracle - SnowConvert AI Custom UDFs[¶](#snowconvert-ai-oracle-snowconvert-ai-custom-udfs "Link to this heading")
...
## BFILENAME UDF[¶](#bfilename-udf "Link to this heading")
...
#### BFILENAME\_UDF(string, string)[¶](#bfilename-udf-string-string "Link to this heading")
...
1. [SSC-EWI-OR0105](../../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/oracleEWI.html#ssc-ewi-or0105): Additional Work Is Needed For BFILE Column Usage.

## CAST\_DATE UDF[¶](#cast-date-udf "Link to this heading")
...
### Custom UDF overloads[¶](#id4 "Link to this heading")

#### CAST\_DATE\_UDF(datestr)[¶](#cast-date-udf-datestr "Link to this heading")
...
#### 1. Oracle DATE contains TIMESTAMP[¶](#oracle-date-contains-timestamp "Link to this heading")
...
## DATE\_TO\_JULIANDAYS\_UDF[¶](#date-to-juliandays-udf "Link to this heading")
...
### Custom UDF overloads[¶](#id13 "Link to this heading")

#### DATE\_TO\_JULIANDAYS\_UDF(date)[¶](#date-to-juliandays-udf-date "Link to this heading")

**Parameters**

1. **INPUT\_DATE**: The `DATE` of the operation.

##### UDF[¶](#id14 "Link to this heading")
...
* [SSC-FDM-OR0042](../../../general/technical-documentation/issues-and-troubleshooting/functional-difference/oracleFDM.html#ssc-fdm-or0042): Date Type Transformed To Timestamp Has A Different Behavior

## DATEADD UDF[¶](#dateadd-udf "Link to this heading")
...
### Custom UDF overloads[¶](#id20 "Link to this heading")
...
#### Usage example[¶](#id25 "Link to this heading")
...
#### 1. Differences in time precision[¶](#differences-in-time-precision "Link to this heading")
...
## DATEDIFF UDF[¶](#datediff-udf "Link to this heading")
...
### Custom UDF overloads[¶](#id33 "Link to this heading")
...
#### 1. Functional differences for timestamps[¶](#functional-differences-for-timestamps "Link to this heading")
...
1. [SSC-EWI-OR0036](../../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/oracleEWI.html#ssc-ewi-or0036): Types resolution issues, the arithmetic operation may not behave correctly between string and date.
...
## JSON\_VALUE UDF[¶](#json-value-udf "Link to this heading")
...
#### JSON\_VALUE Patterns[¶](#json-value-patterns "Link to this heading")
...
### Known Issues[¶](#id55 "Link to this heading")

#### 1. Returning Type Clause is not fully supported[¶](#returning-type-clause-is-not-fully-supported "Link to this heading")
...
#### 2. ON MISMATCH Clause is not supported[¶](#on-mismatch-clause-is-not-supported "Link to this heading")
...
#### 3. Complex filters are not supported[¶](#complex-filters-are-not-supported "Link to this heading")
...
### Related EWIs[¶](#id56 "Link to this heading")
...
## JULIAN TO GREGORIAN DATE UDF[¶](#julian-to-gregorian-date-udf "Link to this heading")
...
### Custom UDF overloads[¶](#id58 "Link to this heading")

#### JULIAN\_TO\_GREGORIAN\_DATE\_UDF(julianDate, formatSelected)[¶](#julian-to-gregorian-date-udf-juliandate-formatselected "Link to this heading")
...
##### Formatted result[¶](#formatted-result "Link to this heading")
...
## MONTHS BETWEEN UDF [DEPRECATED][¶](#months-between-udf-deprecated "Link to this heading")
...
> `MONTHS_BETWEEN` returns number of months between dates `date1` and `date2`. ([Oracle MONTHS\_BETWEEN SQL Language Reference](https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/MONTHS_BETWEEN.html#GUID-E4A1AEC0-F5A0-4703-9CC8-4087EB889952))
...
### Custom UDF overloads[¶](#id67 "Link to this heading")

#### MONTHS\_BETWEEN\_UDF(timestamp\_ltz, timestamp\_ltz)[¶](#months-between-udf-timestamp-ltz-timestamp-ltz "Link to this heading")
...
#### 1. Precision may differ from Oracle[¶](#precision-may-differ-from-oracle "Link to this heading")
...
## REGEXP LIKE UDF[¶](#regexp-like-udf "Link to this heading")
...
##### Parameters[¶](#id81 "Link to this heading")
...
#### **1. UDF match parameter may not behave as expected**[¶](#udf-match-parameter-may-not-behave-as-expected "Link to this heading")
...
##### 2. UDF pattern parameter does not allow only ‘\’ as a regular expression[¶](#udf-pattern-parameter-does-not-allow-only-as-a-regular-expression "Link to this heading")

If as a pattern parameter the regular expression used is only ‘\’ an exception will be thrown like this: JavaScript execution error: Uncaught SyntaxError: Invalid regular expression: //: \ at end of pattern in REGEXP\_LIKE\_UDF at ‘return COL.match(new RegExp(PATTERN));’ position 17 stackstrace: REGEXP\_LIKE\_UDF

## TIMESTAMP DIFF UDF[¶](#timestamp-diff-udf "Link to this heading")
...
### Custom UDF overloads[¶](#id87 "Link to this heading")

#### TIMESTAMP\_DIFF\_UDF(timestamp, timestamp)[¶](#timestamp-diff-udf-timestamp-timestamp "Link to this heading")
...
### Known Issues[¶](#id93 "Link to this heading")

#### 1. TIMESTAMP format may differ from Oracle[¶](#timestamp-format-may-differ-from-oracle "Link to this heading")
...
## TRUNC (date) UDF[¶](#trunc-date-udf "Link to this heading")
...
### Custom UDF overloads[¶](#id96 "Link to this heading")

#### TRUNC\_UDF(date)[¶](#trunc-udf-date "Link to this heading")
...
##### Result[¶](#id101 "Link to this heading")

| DATE |
| --- |
| 1996-03-20 |

#### TRUNC\_UDF(date, fmt)[¶](#trunc-udf-date-fmt "Link to this heading")
...
##### UDF[¶](#id102 "Link to this heading")
...
### TRUNC format scenarios[¶](#trunc-format-scenarios "Link to this heading")

Warning

The results format depends on the DateTime output formats configurated for the database.

#### 1. Natively supported formats[¶](#natively-supported-formats "Link to this heading")
...
#### 2. Formats mapped to another format[¶](#formats-mapped-to-another-format "Link to this heading")
...
##### Result[¶](#id110 "Link to this heading")
...
#### 3. Day formats[¶](#day-formats "Link to this heading")
...
#### 4. Unsupported formats[¶](#unsupported-formats "Link to this heading")
...
#### 1. Oracle DATE contains TIMESTAMP[¶](#id120 "Link to this heading")
...
## TRUNC (number) UDF[¶](#trunc-number-udf "Link to this heading")
...
### Custom UDF overloads[¶](#id123 "Link to this heading")

#### TRUNC\_UDF(n1)[¶](#trunc-udf-n1 "Link to this heading")

It calls Snowflake `TRUNC` [function](https://docs.snowflake.com/en/sql-reference/functions/trunc.html#truncate-trunc) with the input number. This overload exists in order to handle the different types of parameter scenarios, in case that information is not available during the migration.

**Parameters**

1. **INPUT**: The `NUMBER` that needs to be truncated.

##### UDF[¶](#id124 "Link to this heading")
...
##### Oracle[¶](#id125 "Link to this heading")
...
##### Result[¶](#id126 "Link to this heading")
...
##### Result[¶](#id128 "Link to this heading")

| TRUNC\_UDF(1.000001) | TRUNC\_UDF(15.79) | TRUNC\_UDF(-975.975) | TRUNC\_UDF(135.135) |
| --- | --- | --- | --- |
| 1 | 15 | -975 | 135 |

#### TRUNC\_UDF(n1, n2)[¶](#trunc-udf-n1-n2 "Link to this heading")

It calls Snowflake `TRUNC` [function](https://docs.snowflake.com/en/sql-reference/functions/trunc.html#truncate-trunc) with the input number and the scale. This overload exists in order to handle the different types of parameter scenarios, in case that information is not available during the migration.
...
##### UDF[¶](#id129 "Link to this heading")
...
### Known Issues[¶](#id134 "Link to this heading")

No issues were found.

### Related EWIs[¶](#id135 "Link to this heading")

No related EWIs.

# SnowConvert AI - Oracle - INTERVAL UDFs[¶](#snowconvert-ai-oracle-interval-udfs "Link to this heading")

## Necessary code to run INTERVAL UDFs[¶](#necessary-code-to-run-interval-udfs "Link to this heading")
...
## DATEADD UDF INTERVAL[¶](#dateadd-udf-interval "Link to this heading")
...
### Custom UDF overloads[¶](#id137 "Link to this heading")
...
##### UDF[¶](#id138 "Link to this heading")
...
##### UDF[¶](#id139 "Link to this heading")
...
##### UDF[¶](#id140 "Link to this heading")
...
##### UDF[¶](#id141 "Link to this heading")
...
#### Usage example[¶](#id142 "Link to this heading")
...
##### Results[¶](#id144 "Link to this heading")
...
##### Results[¶](#id146 "Link to this heading")
...
#### 1. INTERVAL + INTERVAL Operation is not supported[¶](#interval-interval-operation-is-not-supported "Link to this heading")
...
3. [SSC-FDM-0007](../../../general/technical-documentation/issues-and-troubleshooting/functional-difference/generalFDM.html#ssc-fdm-0007): Element with missing dependencies.
...
## DATEDIFF UDF INTERVAL[¶](#datediff-udf-interval "Link to this heading")
...
### Custom UDF overloads[¶](#id150 "Link to this heading")

#### DATEADD\_DDIF(string, date)[¶](#dateadd-ddif-string-date "Link to this heading")
...
##### UDF[¶](#id151 "Link to this heading")
...
#### DATEADD\_DIFF(date, string)[¶](#dateadd-diff-date-string "Link to this heading")
...
##### UDF[¶](#id152 "Link to this heading")
...
#### DATEADD\_DIFF(string, timestamp)[¶](#dateadd-diff-string-timestamp "Link to this heading")
...
##### UDF[¶](#id153 "Link to this heading")
...
#### DATEADD\_DIFF(timestamp, string)[¶](#dateadd-diff-timestamp-string "Link to this heading")
...
##### UDF[¶](#id154 "Link to this heading")
...
#### Usage example[¶](#id155 "Link to this heading")
...
##### Oracle[¶](#id156 "Link to this heading")
...
### Known Issues[¶](#id160 "Link to this heading")

#### 1. INTERVAL - INTERVAL Operation is not supported[¶](#id161 "Link to this heading")

Snowflake does not support INTERVAL - INTERVAL operations.

### Related EWIs[¶](#id162 "Link to this heading")
...
2. [BFILENAME UDF](#bfilename-udf)
3. [CAST\_DATE UDF](#cast-date-udf)
4. [DATE\_TO\_JULIANDAYS\_UDF](#date-to-juliandays-udf)
5. [DATEADD UDF](#dateadd-udf)
6. [DATEDIFF UDF](#datediff-udf)
7. [JSON\_VALUE UDF](#json-value-udf)
8. [JULIAN TO GREGORIAN DATE UDF](#julian-to-gregorian-date-udf)
9. [MONTHS BETWEEN UDF [DEPRECATED]](#months-between-udf-deprecated)
10. [REGEXP LIKE UDF](#regexp-like-udf)
11. [TIMESTAMP DIFF UDF](#timestamp-diff-udf)
12. [TRUNC (date) UDF](#trunc-date-udf)
13. [TRUNC (number) UDF](#trunc-number-udf)
14. [Necessary code to run INTERVAL UDFs](#necessary-code-to-run-interval-udfs)
15. [DATEADD UDF INTERVAL](#dateadd-udf-interval)
16. [DATEDIFF UDF INTERVAL](#datediff-udf-interval)