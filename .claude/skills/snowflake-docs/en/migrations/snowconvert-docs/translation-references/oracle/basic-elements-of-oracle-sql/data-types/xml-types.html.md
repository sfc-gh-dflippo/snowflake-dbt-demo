---
auto_generated: true
description: Extensible Markup Language (XML) is a standard format developed by the
  World Wide Web Consortium (W3C) for representing structured and unstructured data
  on the World Wide Web. Universal resource ident
last_scraped: '2026-01-14T16:56:21.112940+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/migrations/snowconvert-docs/translation-references/oracle/basic-elements-of-oracle-sql/data-types/xml-types.html
...
[Guides](../../../../../../guides/README.md)[Migrations](../../../../../README.md)Tools[SnowConvert AI](../../../../overview.md)Translation References[Oracle](../../README.md)Basic Elements of Oracle SQL[Data Types](README.md)XML types

# SnowConvert AI - Oracle - XML Types[¶](#snowconvert-ai-oracle-xml-types "Link to this heading")
...
## URIFactory Package[¶](#urifactory-package "Link to this heading")
...
### GETURI[¶](#geturi "Link to this heading")
...
### ESCAPEURI[¶](#escapeuri "Link to this heading")
...
### UNESCAPEURI[¶](#unescapeuri "Link to this heading")
...
### REGISTERURLHANDLER[¶](#registerurlhandler "Link to this heading")
...
### UNREGISTERURLHANDLER[¶](#unregisterurlhandler "Link to this heading")
...
1. [SSC-EWI-OR0007](../../../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/oracleEWI.html#ssc-ewi-or0007): Create Type Not Supported in Snowflake.
2. [SSC-EWI-OR0076](../../../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/oracleEWI.html#ssc-ewi-or0076): Built In Package Not Supported.

## XMLType[¶](#xmltype "Link to this heading")
...
#### XMLType in Create Table[¶](#xmltype-in-create-table "Link to this heading")
...
#### Insert data in the XML column[¶](#insert-data-in-the-xml-column "Link to this heading")
...
#### 1. XMLType manipulation and query functions are not recognized[¶](#xmltype-manipulation-and-query-functions-are-not-recognized "Link to this heading")
...
2. [SSC-EWI-OR0016:](../../../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/oracleEWI.html#ssc-ewi-or0016) XML is not supported.

## URI Data Types[¶](#uri-data-types "Link to this heading")
...
## DBURIType[¶](#dburitype "Link to this heading")
...
#### DBURIType in create table[¶](#dburitype-in-create-table "Link to this heading")
...
#### Retrieving data from DBURIType column[¶](#retrieving-data-from-dburitype-column "Link to this heading")
...
| DT.DB\_URITYPE\_COLUMN.GETCLOB() |
| --- |
| ¶ <FIRST\_NAME>Shelley</FIRST\_NAME>¶ |
...
1. [SSC-EWI-0028](../../../../general/technical-documentation/issues-and-troubleshooting/conversion-issues/generalEWI.html#ssc-ewi-0028): Type not supported.
...
## HTTPURIType[¶](#httpuritype "Link to this heading")
...
#### HTTPURIType in create table[¶](#httpuritype-in-create-table "Link to this heading")
...
#### Retrieving data from HTTPURIType column[¶](#retrieving-data-from-httpuritype-column "Link to this heading")
...
| UT.HTTP\_URITYPE\_COLUMN.GETURL() | UT.HTTP\_URITYPE\_COLUMN.GETEXTERNALURL() |
| --- | --- |
...
## XDBURIType[¶](#xdburitype "Link to this heading")
...
### Sample Source Patterns[¶](#id39 "Link to this heading")

#### XDBURIType in create table[¶](#xdburitype-in-create-table "Link to this heading")

##### Oracle[¶](#id40 "Link to this heading")
...
#### Retrieving data from XDBURIType column[¶](#retrieving-data-from-xdburitype-column "Link to this heading")
...
| UT.XDB\_URITYPE\_COLUMN.GETCLOB() |
| --- |
| <emp\_name>selby</emp\_name> |
...
### Related EWIs[¶](#id46 "Link to this heading")
...
2. [URIFactory Package](#urifactory-package)
3. [XMLType](#xmltype)
4. [URI Data Types](#uri-data-types)
5. [DBURIType](#dburitype)
6. [HTTPURIType](#httpuritype)
7. [XDBURIType](#xdburitype)