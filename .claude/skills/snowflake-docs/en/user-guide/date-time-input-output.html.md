...
description: Date and time formats provide a method for representing dates, times,
  and timestamps.
last_scraped: '2026-01-14T16:56:29.599675+00:00'
scraper_version: 1.1.0
source_url: https://docs.snowflake.com/en/user-guide/date-time-input-output.html
...
2. [SQL data types reference](../sql-reference-data-types.md)
   ...
   * [Date & time](../sql-reference/data-types-datetime.md)
     ...
     + [Input and output formats](../sql-reference/date-time-input-output.md)
...
[Reference](../reference.md)[SQL data types reference](../sql-reference-data-types.md)[Date & time](../sql-reference/data-types-datetime.md)Input and output formats
