...
> **Do NOT begin manual conversion.** IBM DB2 has **full SnowConvert AI support** (tables, views,
> procedures, functions). Before writing any dbt model by hand:
>
...
> source object name (lowercased, without schema prefix). For example, `SCHEMA1.PATIENT_VISITS`
