...
```sql
## *** Generated code is based on the SnowConvert AI Python Helpers version 2.0.6 *** 2
...
```sql
## *** Generated code is based on the SnowConvert AI Python Helpers version 2.0.6 *** 3
...
```sql
## *** Generated code is based on the SnowConvert AI Python Helpers version 2.0.6 *** 4
...
```sql
## *** Generated code is based on the SnowConvert AI Python Helpers version 2.0.6 *** 5
