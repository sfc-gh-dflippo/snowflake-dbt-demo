...
###### Workaround to get the same functionality 2
...
###### Workaround to get the same functionality 3
...
#### Case 7 - multiple columns _expression_ - different sizes by table: UNION ALL for columns varchar (20), varchar(20) over columns varchar (10), varchar(10)
...
#### Case 8 - multiple columns _expression_ - different sizes by table: UNION ALL for columns varchar (20), varchar(20) over columns varchar (10), varchar(10)
...
###### Workaround to get the same functionality 4
