...
> **Do NOT begin manual conversion.** Teradata has **full SnowConvert AI support** (tables, views,
> procedures, functions, BTEQ/MLOAD/TPUMP). Before writing any dbt model by hand:
>
...
> source object name (lowercased, without database prefix). For example, `DBC.PatientVisits` becomes
