...
### Snowflake Behavior[¶](#snowflake-behavior)
...
### SET QUOTED_IDENTIFIER ON[¶](#set-quoted-identifier-on)
...
#### SQL Server (with \_CI collation):[¶](#sql-server-with-ci-collation)
...
### SET QUOTED_IDENTIFIER OFF[¶](#set-quoted-identifier-off)
...
## Related EWIs and FDMs[¶](#related-ewis-and-fdms)
