...
#### Common Table Expression with SELECT INTO[¶](#common-table-expression-with-select-into)
...
#### Common Table Expression with MERGE statement[¶](#common-table-expression-with-merge-statement)
...
#### Delete duplicates from a table[¶](#delete-duplicates-from-a-table)
...
#### DELETE WITH INNER JOIN[¶](#delete-with-inner-join)
...
#### DELETE WITH LEFT JOIN[¶](#delete-with-left-join)
...
#### DELETE WITH RIGHT JOIN[¶](#delete-with-right-join)
...
#### Case 3: Multiple `INNER JOIN` Update with Aggregate Condition[¶](#case-3-multiple-inner-join-update-with-aggregate-condition)
...
#### Case 4: Single `LEFT JOIN` Update[¶](#case-4-single-left-join-update)
...
#### Case 5: Multiple `LEFT JOIN` and `RIGHT JOIN` Update[¶](#case-5-multiple-left-join-and-right-join-update)
...
#### Case 6: Mixed `INNER JOIN` and `LEFT JOIN` Update[¶](#case-6-mixed-inner-join-and-left-join-update)
...
#### Case 7: Single `RIGHT JOIN` Update[¶](#case-7-single-right-join-update)
...
## UPDATE with LEFT and RIGHT JOIN[¶](#update-with-left-and-right-join)
...
##### Output After Query[¶](#output-after-query)
