...
This directory contains translation references for converting Teradata code to Snowflake-compatible SQL.
...
- [Built-in Functions](sql-translation-reference/teradata-built-in-functions.md) - Function equivalents
...
- [SQL to Snowflake Scripting](teradata-to-snowflake-scripting-translation-reference.md) - Stored procedure conversion
