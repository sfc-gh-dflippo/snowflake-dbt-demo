...
## BTEQ Commands Translation[¶](#bteq-commands-translation)
...
### .GOTO Conversion[¶](#goto-conversion)
...
### Execute Query Statements[¶](#execute-query-statements)
...
##### TESTTABU2 Result[¶](#testtabu2-result)
...
## USING REQUEST MODIFIER[¶](#using-request-modifier)
