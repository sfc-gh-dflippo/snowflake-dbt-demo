...
### BEGIN END TRANSACTION[¶](#begin-end-transaction)
...
## DML and DDL Objects[¶](#dml-and-ddl-objects)
...
#### SQLEXCEPTION HANDLER[¶](#sqlexception-handler)
...
### Sample Source Patterns [¶](#id251)

#### Data setting for examples[¶](#data-setting-for-examples)
...
#### Simple scenario with RETURN ONLY[¶](#simple-scenario-with-return-only)
...
#### Reused cursor case[¶](#reused-cursor-case)
...
#### Simple cursor combined with no PREPARE pattern[¶](#simple-cursor-combined-with-no-prepare-pattern)
...
#### Prepare combined with nested cursors[¶](#prepare-combined-with-nested-cursors)
...
#### Variable markers with variable reordering[¶](#variable-markers-with-variable-reordering)
