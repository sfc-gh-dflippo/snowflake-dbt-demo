...
|[TIME WITH TIMEZONE (TIMETZ)](https://docs.vertica.com/25.1.x/en/sql-reference/data-types/datetime-data-types/timestamptimestamptz/)|[TIME](https://docs.snowflake.com/en/sql-reference/data-types-datetime#label-datatypes-time) _Notes: TIME data type in Snowflake does not persist this timezone attribute._ [_`SSC-FDM-0005`_](../general/technical-documentation/issues-and-troubleshooting/functional-difference/general/ssc-fdm-0005.md) _is added._|
...
## Approximate Numeric Data Type[¶](#approximate-numeric-data-type)
...
## Exact Numeric Data Type[¶](#exact-numeric-data-type)
