...
> **Do NOT begin manual conversion.** SQL Server has **full SnowConvert AI support** (tables, views,
> procedures, functions, SSIS). Before writing any dbt model by hand:
>
...
> source object name (lowercased, without schema prefix). For example, `dbo.PatientVisits` becomes
