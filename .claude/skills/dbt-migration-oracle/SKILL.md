...
> **Do NOT begin manual conversion.** Oracle has **full SnowConvert AI support** (tables, views,
> procedures, functions, packages). Before writing any dbt model by hand:
>
...
> source object name (lowercased, without schema prefix). For example, `HR.EMPLOYEE_BENEFITS`
> becomes `employee_benefits.sql`. Do not rename objects during migration unless explicitly
