...
## Between operator helper[¶](#between-operator-helper)

### Between Operator Helper Function Definition[¶](#between-operator-helper-function-definition)
...
### Concat Helper Function Definition[¶](#concat-helper-function-definition)
...
##### Valid arguments for opts parameter[¶](#valid-arguments-for-opts-parameter)

The following tables describe, how arguments should be sent to opts parameter in EXEC call:

##### Options when a query returns a single row[¶](#options-when-a-query-returns-a-single-row)
...
##### Options when a query returns multiple rows[¶](#options-when-a-query-returns-multiple-rows)
...
### EXEC Helper Function Definition[¶](#exec-helper-function-definition)
...
#### EXEC simple case[¶](#exec-simple-case)
...
## IS NULL Helper[¶](#is-null-helper)

### IS NULL Helper Function Definition[¶](#is-null-helper-function-definition)
...
### Like Operator Helper Function Definition[¶](#like-operator-helper-function-definition)
...
### Raise Helper Function Definition[¶](#raise-helper-function-definition)
...
### ROWTYPE Helper Function Definition[¶](#rowtype-helper-function-definition)
